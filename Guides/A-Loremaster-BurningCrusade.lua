...
startlevel 68
		...
		step
			goto Netherstorm,32.4,64.2
			.talk Nether-Stalker Khay'ji##19880
			..turnin Assisting the Consortium##10264
			..accept Consortium Crystal Collection##10265
			only if rep ('The Scryers') >= Neutral
		step
		...
		step
			goto Netherstorm,30,51.55
			.from Weaken Phase Hunters##18879
			.info You will see a message in your chat window saying "Phase Hunter is very weak".
			.use Battery Recharging Blaster##28369
			.' Battery Charge Level|q 10190/1
			.' You can find more around (1)|at 26.5,51.9
			.' You can find more around (2)|at 23.75,43.98
		step
			goto Netherstorm,31.5,56.6
			.talk Bot-Specialist Alley##19578
		...
		step
			.goal Escort Maxx A. Million Mk. V to safety through the ruins|q 10191/1
			.info Click the red glowing crystals on the ground while escorting Maxx A. Million Mk. V
			.collect 10 Etherlithium Matrix Crystal##28364|q 10186/1
		step
			goto Netherstorm,31.5,56.6
			.talk Bot-Specialist Alley##19578
		...
		step
			...
			.get 5 Shaleskin Shale##29464|q 10342/1
		...
		step
			...
			.get 7 Mana Wraith Essence##28527|q 10224/1
		step
			goto Netherstorm,32.4,66.8
			.talk Chief Engineer Trep##19709
		...
		step
			...
			.get B'naar Personnel Roster##28376|q 10189/1
			only if rep ('The Scryers') >= Neutral
		step
		...
		step
			...
			.use Elemental Power Extractor##28547
			.from Sundered Rumbler##18881, Warp Aberration##18865
			.get 5 Elemental Power##28548|q 10226/1
		step
		...
		step
			...
			.get Arklon Crystal Artifact##28829|q 10265/1
		step
		...
		step
			...
			.use Conjuring Powder##29207
			.from Ekkorash the Inquisitor##19493
			.get Archmage Vargoth's Staff##28292|q 10173/1
		step
			goto Netherstorm,44.6,72.1
			.from Nether Ray##18880
			.get 5 Nether Ray Stinger##28417|q 10199/1
			.' You can find more around|at 34.8,74.2
		step
		...
		step
			...
			.get 4 Flawless Crystal Shard##29216|q 10300/1
		step
			goto Netherstorm,35,59.6
			.info Dr. Boom sends out little walking bombs that blow up.
			.info When you see a clear passage to Dr. Boom, click the Boom's Doom in your bags, then run close enough to Dr. Boom so you can put the green circle under him, then click to throw the bomb.
		...
		step
			goto Netherstorm,26.33,68.55
			.from Sunfury Magister##18855
			.collect Bloodgem Shard##28452|q 10204
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,26.06,68.34
			.use Bloodgem Shard##28452
			.' Siphon the Bloodgem Crystal|q 10204/1
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,27.67,71.18
		...
		step
			...
			.get Annihilator Servo##28787|q 10261/1
		step
			goto Netherstorm,26.8,77
			.talk N. D. Meancamp##19690
			..accept It's a Fel Reaver, But with Heart##10309
		step
			goto Netherstorm,26.5,78.7
			.use Fel Zapper##29447
			.from Scrapped Fel Reaver##20243
			.info While you are beating the robot, the Ethereals will attack you.
			.get Heart of the Fel Reaver##29260|q 10309/1
		step
			goto Netherstorm,26.8,77
			.talk N. D. Meancamp##19690
			..turnin It's a Fel Reaver, But with Heart##10309
		step
			goto Netherstorm,33.5,78.9
			...
			.' You can find it here (1)|at 19.2,74.6
			.' You can find it here (2)|at 27.15,80.35
			.' You can find it here (3)|at 40.9,76.3
		step
		...
		step
			...
			.' Interact with gameobject: B'naar Control Console
		...
		step
			...
			.get 10 Zaxxis Insignia##29209|q 10262/1
			.info Take the insignia from the loot.
			.collect 10 Ethereal Technology##28457|q 10206/1
			.info Energy cubes and cylinders lie on the ground.
		step
		...
		step
			...
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,24.83,67.7|n
			.' Go inside Manaforge B'naar|goto 24.83,67.7,0.5|noway|q 10329
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,23.9,70.7
			.from Overseer Theredis##20416
			.get B'naar Access Crystal##29366|q 10329/2
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,23.2,68.1
			.' Interact with gameobject: B'naar Control Console
			...
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,24.87,67.69|n
			.' Go inside Manaforge B'naar|goto 24.87,67.69,0.5|noway|q 10299
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,23.8,70.7
			.from Overseer Theredis##20416
			.get B'naar Access Crystal##29366|q 10299/2
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,23.2,68.1
		...
		step
			...
			.' You will fly to Manaforge Coruu|goto 48,86,2|noway|q 10652
			only if rep ('The Scryers') >= Neutral
		step
		...
		step
			...
			.get Sunfury Arcanist Robes##28635|q 10197/3
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,50.8,83.2
			.from Sunfury Guardsmen##18850
			.get Sunfury Guardsman Medallion##28637|q 10197/2
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,50.47,83.13|n
			.' Go inside Manaforge Coruu|goto 50.47,83.13,0.5|noway|q 10197
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,49,81.5
			.from Sunfury Researcher##20136
			.get Sunfury Researcher Gloves##28636|q 10197/1
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,48.2,86.6
			.talk Caledis Brightdawn##19840
		...
		step
			...
			.' Gain Sunfury Disguise buff|havebuff INV_Mask_01|q 10198
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,50.5,83.15|n
			.' Go inside Manaforge Coruu|goto 50.5,83.15,0.5|noway|q 10198
			only if rep ('The Scryers') >= Neutral
		step
		...
		step
			goto Netherstorm,50.5,83.15|n
			.' Go inside Manaforge Coruu|goto 50.5,83.15,0.5|noway|q 10330
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,49,81.5
			.from Overseer Seylanna##20397
			.collect Coruu Access Crystal##29396|q 10330/2
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,49,81.5
			.' Interact with gameobject: Coruu Control Console
			.' Choose "<Begin emergency shutdown>"
		...
		step
			...
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,47.29,80.97|n
			.' Go inside Manaforge Coruu|goto 47.29,80.97,0.5|noway|q 10321
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,48.6,81.85
			.kill 5 Sunfury Researcher##20136|q 10246/1
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,49,81.43
			.from Overseer Seylanna##20397
			.get Coruu Access Crystal##29396|q 10321/2
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,49,81.43
			.' Interact with gameobject: Coruu Control Console
		...
		step
			...
			.get Sigil of Krasus##28368|q 10188/1
		step
			.use Archmage Vargoth's Staff##28455
			.talk Image of Archmage Vargoth##19644
		...
		step
			...
			.collect Belmara's Tome##29234|q 10305 |future
		step
		...
		step
			...
			.collect Cohlien's Cap##29236|q 10307 |future
		step
		...
		step
			...
			.collect Dathric's Blade##29233|q 10182 |future
		step
		...
		step
			...
			.info He walks around this area, some searching may be necessary.
			.collect Luminrath's Mantle##29235|q 10306 |future
		step
		...
		step
			...
			.get Smithing Hammer##29365|q 10331/1
		step
		...
		step
			goto Netherstorm,56.87,86.84
			.use Dathric's Blade##28351
			.info Go inside the little house.
			.info Click Dathric's Blade when standing next to the Weapon Rack.
			.' Put Dathric's Spirit to Rest|q 10182/1
		step
			goto Netherstorm,56.4,87.8
			.use Luminrath's Mantle##28352
			.info Go inside the little house.
			.info Click Luminrath's Mantle when standing next to the Dresser.
			.' Put Luminrath's Spirit to Rest|q 10306/1
		step
			goto Netherstorm,55.7,87.2
			.collect Mana Bomb Fragment##29461|q 10343/1
			.info A huge magic ball lies on the ground.
		step
			goto Netherstorm,55.1,87.5
			.use Cohlien's Cap##28353
			.info Use Cohlien's Cap when standing next to the Foot Locker.
		...
		step
			...
			.info Click Belmara's Tome when standing next to the Bookshelf.
		...
		step
			...
			.from Battle-Mage Dathric##19543
			.info He is inside the building that looks like a town hall.
			.get Annals of Kirin'Var##29331|q 10312/1
		step
			goto Netherstorm,57.5,86.3
			.talk Custodian Dieworth##19488
		...
		step
			...
			.' Interact with gameobject: Necromantic Focus
			.info Inside the barn.
		...
		step
			...
			.get 10 Loathsome Remnant##29338|q 10314/1
		step
			goto Netherstorm,57.5,86.3
			.talk Custodian Dieworth##19488
		...
		step
			...
			.' Interact with gameobject: Suspicious Outhouse
			.info Behind the tavern.
			.collect Naberius's Phylactery##29361|q 10319/1
		step
			goto Netherstorm,57.5,86.3
			.talk Custodian Dieworth##19488
		...
		step
			goto Netherstorm,51.1,82.5
			.' Interact with gameobject: Energy Isolation Cube
			.collect 10 Energy Isolation Cube##28564|q 10239/1
		step
			goto Netherstorm,57.6,89.6
			.' Interact with gameobject: Krasus' Compendium - Chapter 2
			.collect Krasus's Compendium - Chapter 2##28473|q 10192/2
			.info Scroll with white glow.
		step
			goto Netherstorm,58.6,89.2
			.' Interact with gameobject: Krasus' Compendium - Chapter 1
			.collect Krasus's Compendium - Chapter 1##28472|q 10192/1
			.info Scroll with white glow.
		step
			goto Netherstorm,58.8,87.9
			.' Interact with gameobject: Krasus' Compendium - Chapter 3
			.collect Krasus's Compendium - Chapter 3##28474|q 10192/3
			.info Scroll with white glow.
		step
			.use Archmage Vargoth's Staff##28455
			.talk Image of Archmage Vargoth##19644
		...
		step
			...
			.use Rune Activation Device##28725
		...
		step
			...
			.collect Flaming Torch##28550|q 10233
		step
			goto Netherstorm,55.45,78.98
			.use Flaming Torch##28550
			.' Destroy 4 Sunfury Ballistas|q 10233/1
		step
			goto Netherstorm,55.92,77.38
			.use Flaming Torch##28550
		...
		step
			...
			.get Heliotrope Oculus##28475|q 10301/1
		step
			.use Archmage Vargoth's Staff##28455
			.talk Image of Archmage Vargoth##19644
		...
		step
			...
			.info Use Apex's Crystal Focus next to Archmage Vargoth's Orb.
		...
		step
			...
			.goal Burning Legion warp-gate sabotaged|q 10310/1
		step
			goto Netherstorm,46.7,56.9
			.talk Gahruj##20066
		...
		step
			...
			.collect Diagnostic Results##29741|q 10417/1
		step
			goto Netherstorm,48.2,53.9
			.collect 15 Ivory Bell##29474|q 10348/1
		step
			goto Netherstorm,44.05,55.37
			.from Ripfang Lynx##20671
			.get 10 Ripfang Lynx Pelt|q 10433/1
		step
			goto Netherstorm,49.69,58.22
			.collect 10 Fel Reaver Parts##28551|q 10234/1
		step
		...
		step
			...
			.from Doomclaw##19738
			.get Doomclaw's Hand##28563|q 10235/1
		step
			goto Netherstorm,57.9,63.4
			.from Sunfury Conjurer##20139
			.get 1 Sunfury Arcane Briefing##29546|q 10328/2
			.from Sunfury Bowman##20207, Sunfury Centurion##20140
			.get 1 Sunfury Military Briefing##29545|q 10328/1
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,57.9,63.4
		...
		step
			...
			.collect 10 Box of Surveying Equipment##28913|q 10267/1
		step
			goto Netherstorm,61,65.55|n
			.' Go inside Manaforge Duro|goto 61,65.55,0.5|noway|q 10322
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,60,68.5
			.from Overseer Athanel##20435
			.get Duro Access Crystal##29397|q 10322/2
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,59.1,66.8
			.' Interact with gameobject: Duro Control Console
			.' Choose "<Begin emergency shutdown>"
			.info Kill the technicians as they come to try to save the Manaforge.
			.info Only takes 2 minutes.
			...
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,61.1,65.5|n
			.' Go inside Manaforge Duro|goto 61.1,65.5,0.5|noway|q 10338
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,60,68.5
			.from Overseer Athanel##20435
			.get Duro Access Crystal##29397|q 10338/2
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,59.1,66.8
			.' Interact with gameobject: Duro Control Console
		...
		step
			...
			.use Scrap Reaver X6000 Controller##28634
			.from Negatron##19851
		...
		step
			...
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,26.4,44|n
			.' The entrance to Trelleum Mine starts here|goto 26.4,44,0.5|noway|q 10317
		step
		...
		step
			...
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,26.2,39.6
			.from Overseer Azarad##20685
			.get Ara Access Crystal##29411|q 10365/2
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,26,38.75
			.' Interact with gameobject: Ara Control Console
			.' Choose "<Begin emergency shutdown>"
			.info Kill the technicians as they come to try to save the Manaforge.
			.info Only takes 2 minutes.
			.' Shut Down Manaforge Ara|q 10365/1
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,24.65,41.8
			.from Daughter of Destiny##18860, Gan'arg Warp-Tinker##20285, Mo'arg Warp-Master##20326
			.get 8 Orders From Kael'thas##29797|q 10432/1
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,25.92,41.6|n
			.' Go inside of Manaforge Ara|goto 25.92,41.6,0.5|noway|q 10323
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,26,38.9
			.from Overseer Azarad##20685
			.info He walks around inside Manaforge Ara and stops in at this small side room.
			.get Ara Access Crystal##29411|q 10323/2
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,26,38.8
			.' Interact with gameobject: Ara Control Console
			.' Choose "<Begin emergency shutdown>"
			.info Kill the technicians as they come to try to save the Manaforge.
			.info Only takes 2 minutes.
		...
		step
			...
			.collect 10 Dome Generator Segment##29798|q 10435/1
		step
			goto Netherstorm,46.8,18.2
			.from Farahlon Breaker##18886
			.get 4 Raw Farahlite##29163|q 10290/1
		step
		...
		step
			goto Netherstorm,47.5,21.1
			.from Cragskaar##20202
			.get Farahlite Core##29164|q 10293/1
			.' You can find it here|at 49.8,17.2
		step
			goto Netherstorm,43.5,35.2
			.talk Ghabar##20811
		...
		step
			...
			.use Energy Field Modulator##29818
		...
		step
			...
			.use Talbuk Tagger##29817
			.info Use the Talbuk Tagger on Talbuks when they are below 20 percent health.
		...
		step
			...
			.from Markaru##20775
			.get Hulking Hydra Heart##29768|q 10429/1
		step
			goto Netherstorm,42.3,32.6
			.talk Aurine Moonblaze##20871
		...
		step
			...
			.info A red arrow will appear showing you where to go.
		...
		step
			...
			.' Interact with gameobject: Ethereum Transponder Zeta
			.talk Image of Commander Ameer##20482
			..turnin The Ethereum##10339
			..accept Ethereum Data##10384
		step
			goto Netherstorm,55.8,39.9
			.' Interact with gameobject: Ethereum Data Cell
			.collect Ethereum Data Cell##29582|q 10384/1
		step
			goto Netherstorm,54.55,40.43
			.from Warden Icoshock##20770
			.collect The Warden's Key##29742|q 10422
		step
			goto Netherstorm,53.3,41.5
			.' Interact with gameobject: Captain Tyralius's Prison
			.info It looks like a glowing pink orb
			.' Free Captain Tyralius|q 10422/1
		step
			.use Navuud's Concoction##29737
			.' Gain Electro-Shock Therapy Buff|havebuff Spell_Lightning_LightningBolt01|q 10411
		step
			goto Netherstorm,55.2,42.8
			.use Navuud's Concoction##29737
			.' Gain Electro-Shock Therapy Buff|havebuff Spell_Lightning_LightningBolt01|q 10411
			.info While under the effects of the Electro-Shock Therapy buff do the following:
		...
		step
			goto Netherstorm,56.8,38.7
			.' Interact with gameobject: the Ethereum Transponder Zeta
			.talk Image of Commander Ameer##20482
		...
		step
			...
			.get 15 Ethereum Relay Data##29459|q 10385/1
		step
			goto Netherstorm,56.8,38.7
			.' Interact with gameobject: Ethereum Transponder Zeta
			.talk Image of Commander Ameer##20482
		...
		step
			...
			.get Prepared Ethereum Wrapping##29591|q 10405/1
		step
			goto Netherstorm,56.8,38.7
			.' Interact with gameobject: Ethereum Transponder Zeta
			.talk Image of Commander Ameer##20482
		...
		step
			goto Netherstorm,53.6,42.4
			.use Protectorate Disruptor##29618
			.kill Nexus-King Salhadaar##20454|q 10408/1
			.info Use the Protectorate Disruptor on the columns to free him.
			.' Column on which to use the disruptor (1)|at 54,43.33
			.' Column on which to use the disruptor (2)|at 53.8,41.6
			.' Column on which to use the disruptor (3)|at 52.95,42.4
		step
			goto Netherstorm,56.8,38.7
			.' Interact with gameobject: Ethereum Transponder Zeta
			.talk Image of Commander Ameer##20482
		...
		step
			...
			.goal Escort Captured Protectorate Vanguard|q 10425/1
		step
			goto Netherstorm,59.5,32.4
			.talk Commander Ameer##20448
		...
		step
			...
			.get 8 Fragment of Dimensius##29822|q 10437/1
		step
			...
			.info While under the effects of the Electro-Shock Therapy buff do the following:
			.info This buff lasts for 60 minutes. High levels will need to use melee since the effect only works by random chance.
			.kill Seeping Sludge##20501|n
			.kill 30 Seeping Sludge Globule##20806|q 10411/1
			.' You can find more around|at 65.82,40.75
		step
		...
		step
			...
			.' The entrance to the Access Shaft Zeon cave starts here|goto 61,45.6,0.5|noway|q 10345
		step
		...
		step
			...
			.' Interact with gameobject: Teleporter Power Pack
			.collect Teleporter Power Pack##28969|q 10270/1
		step
			goto Netherstorm,60.1,40.1
			.kill Arconus the Insatiable##20554|q 10353/1
		step
			goto Netherstorm,61.1,45.4|n
			.' Leave the Access Shaft Zeon|goto 61.1,45.4,0.5|noway|q 10345
		step
			goto Netherstorm,59.4,45.0
			.talk Agent Araxes##20551
		...
		step
			...
			.' Interact with gameobject: Ethereum Transponder Zeta
			.info Attempt to contact Wind Trader Marid.
		...
		step
			...
			.from Nether Drake##18877, Nether Dragon##20332
			.get 8 Nether Dragon Essence##28970|q 10271/1
		step
		...
		step
			...
			.collect 15 Nether Dragonkin Egg##28971|q 10272/1
		step
			goto Netherstorm,71.2,35.1
			.talk Tyri##20110
		...
		step
			...
			.from Culuthas##20138
			.get Ata'mal Crystal##29026|q 10276/1
		step
			goto Netherstorm,45.9,36.0
			.talk Image of Nexus-Prince Haramad##20084
		...
		step
			goto Netherstorm,32.7,65
			.talk Rocket-Chief Fuselage##19570
			..turnin Back to the Chief!##10249
		step
			goto Netherstorm,32.1,64.2
			.talk Exarch Orelis##19466
		...
		step
			goto Netherstorm,32,64.1
			.talk Spymaster Thalodien##19468
			..turnin Shutting Down Manaforge Ara##10365
			..turnin Damning Evidence##10432
			only if rep ('The Scryers') >= Neutral
		step
			goto Netherstorm,37.1,27.8
			.from Forgemaster Morug##20800
			.get First Half of Socrethar's Stone##29624|q 10407/1
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,40.8,19.6
			.from Silroth##20801
			.get Second Half of Socrethar's Stone##29625|q 10407/2
			only if rep ('The Aldor') >= Neutral
		step
			goto Netherstorm,32.0,64.2
			.talk Anchorite Karja##19467
		...
		step
			...
			only if rep ('The Aldor') >= Neutral
		step
			.' Congratulations! +123/120 quests for achievement "Into the Nether".
]])
...
startlevel 68
		...
		step
			...
			.' You can find more around|at 51.35,53.67
		step
			goto Shadowmoon Valley,42.19,45.07
			.talk Earthmender Torlok##21024
		...
		step
			goto Shadowmoon Valley,37.25,30.7
			.from Dark Conclave Shadowmancer##19826, Dark Conclave Ravenguard##19827, Dark Conclave Hawkeye##21386
			.get Sketh'lon Commander's Journal - Page 1##31260|q 10569/1
			.get Sketh'lon Commander's Journal - Page 2##31261|q 10569/2
			.get Sketh'lon Commander's Journal - Page 3##31262|q 10569/3
		step
		...
		step
			...
			.' You can get more Shadowmoon Harbinger|at 38.75,53.78
		step
		...
		step
			goto Shadowmoon Valley,53.05,25.55|n
			.' Enter the cave and move along it|goto 53.19,24.95,0.5|noway|q 10451 |future
		step
			goto Shadowmoon Valley,51.66,17.66
			...
			..accept Escape from Coilskar Cistern##10451|at 52.10,18.82
		step
			goto Shadowmoon Valley,53.13,25.19
			.' Watch the dialogue.
		...
		step
			goto Shadowmoon Valley,40.16,38.16|n
			.' Enter the cave|goto 40.16,38.16,0.5|noway|q 10585
		step
			goto Shadowmoon Valley,37.37,41.68
			.from Deathforge Tinkerer##19754, Deathforge Smith##19756
			.info Inside the cave.
			.get Elemental Displacer##30672|q 10585/2
		step
		...
		step
			goto Shadowmoon Valley,40.16,38.16|n
			.' Enter the cave|goto 40.16,38.16,0.5|noway|q 10586
		step
			goto Shadowmoon Valley,37.37,42.68|n
			.' You need to open this grate and move on|goto 37.37,42.68,0.5|noway|q 10586
		step
			goto Shadowmoon Valley,38.90,46.78
			.kill Warbringer Razuun##21287|q 10586/1
			.get Razuun's Orders##30689|q 10586/2
			.info Inside the cave.
		step
			goto Shadowmoon Valley,39.50,53.73
			.talk Wing Commander Nuainn##21357
		...
		step
			...
			.info He walks around this area.
			.collect Illidari-Bane Shard##30756|q 10621 |future
		step
			.use Illidari-Bane Shard##30756
		...
		step
			...
			.collect The Doctor's Key##30712|q 10606
		step
			goto Shadowmoon Valley,39.38,19.48
			.' Interact with gameobject: The Doctor's Strongbox
		...
		step
			...
			.' Interact with gameobject: Fel Reaver Control Console
			.' Control a Fel Reaver Sentinel|havebuff INV_Gizmo_GoblingTonkController|q 10612
		step
		...
		step
			.' Stop Controlling the Fel Reaver|nobuff INV_Gizmo_GoblingTonkController|q 10612
		...
		step
			...
			.' You can find more around (1)|at 62.51,61.91
			.' You can find more around (2)|at 65.48,56.69
		step
			goto Shadowmoon Valley,69.80,85.93
			.use Spectrecles##30721
			.from Vhel'kur##21801
			.info Make sure to equip the Spectrecles.
			...
			.get Gorefiend's Armor##30797|q 10634/1
		step
			goto Shadowmoon Valley,58.23,70.79
			.talk Ancient Shadowmoon Spirit##21797
		...
		step
			...
			.' Interact with gameobject: Zuluhed's Chains
		...
		step
			...
			.from Lakaan##21416
			.get Lakaan's Medallion Fragment##30693|q 10574/3
			only if rep ('The Aldor') >= Neutral
		step
			goto Shadowmoon Valley,53.92,23.53
			.talk Oronok Torn-heart##21183
		...
		step
			...
			.' Interact with gameobject: Ravenous Flayer Egg
		...
		step
			...
			.' Interact with gameobject: Coilskar Chest
		...
		step
			...
			.info You must destroy the totems before you can attack him.
			.from Uylaru##21710|n
			.get Uylaru's Medallion Fragment##30694|q 10574/4
			only if rep ('The Aldor') >= Neutral
		step
			...
			.info You must destroy the totems before you can attack him.
			.from Eykenen##21709
			.get Eykenen's Medallion Fragment##30692|q 10574/1
			only if rep ('The Aldor') >= Neutral
		step
			goto Shadowmoon Valley,56.25,59.60
			.talk Arcanist Thelis##21955
		...
		step
			...
			.info You must destroy the totems before you can attack him.
			.from Lakaan##21416
			.get Lakaan's Medallion Fragment##30693|q 10685/3
			only if rep ('The Scryers') >= Neutral
		step
			goto Shadowmoon Valley,48.2,39.8
			.kill Corrupt Fire Totem##21703|n
			.info You must destroy the totems before you can attack him.
			.from Uylaru##21710
			.get Uylaru's Medallion Fragment##30694|q 10685/4
			only if rep ('The Scryers') >= Neutral
		step
			goto Shadowmoon Valley,51.3,52.9
			.kill Corrupt Earth Totem##21704|n
			.info You must destroy the totems before you can attack him.
			.from Eykenen##21709|n
			.get Eykenen's Medallion Fragment##30692|q 10685/1
			only if rep ('The Scryers') >= Neutral
		step
		...
		step
			...
			.info You must destroy the totems before you can attack him.
			.from Haalum##21711
			.get Haalum's Medallion Fragment##30691|q 10574/2|only if rep ('The Aldor') >= Neutral
			.get Haalum's Medallion Fragment##30691|q 10685/2|only if rep ('The Scryers') >= Neutral
		step
		...
		step
			...
			.from Arvoar the Rapacious##23267
			.info He walks around this small area.
			.info You may need help with this.
			.collect Partially Digested Hand##32621|q 11041 |future
		step
			.use Partially Digested Hand##32621
		...
		step
			...
			.' Wear the Blood Elf Disguise|havebuff INV_Mask_01|q 10577
		...
		step
			...
			.buy Adamantite Frame##23784|q 10664/1
		...
		step
			.' Congratulations! +90 quests for achievement "Shadow of the Betrayer".	
]])
