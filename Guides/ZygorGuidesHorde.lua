...
startlevel 1
	...
	step //98
		...
		.collect Egalin's Grimoire##6285|q 1473/1
...
startlevel 1
	...
	step //3
		...
		.get 7 Plainstrider Meat##4739|q 747/1
		.get 7 Plainstrider Feather##4740|q 747/2
	step //4
		ding 2
	step //5
		goto 44.9,77.1
		...
		..accept Simple Note##3091 |only Tauren Warrior
		..accept Etched Note##3092 |only Tauren Hunter
		..accept Rune-Inscribed Note##3093 |only Tauren Shaman
		..accept Verdant Note##3094 |only Tauren Druid
	step //9
		goto 44.0,76.1
	...
	step
		goto 50.22,81.37
		.collect Water Pitcher##4755|q 753/1
		.info A little Water Pitcher sitting on the windmill.
	step //14
		goto 44.2,76.1
		.talk Chief Hawkwind##2981
	...
	step //15
		...
		.get 10 Mountain Cougar Pelt##4742|q 750/1
	step //16
		ding 3
	step //17
		goto 42.6,92.2
	...
	step //20
		...
		.get 8 Battleboar Snout##4848|q 780/1
		.get 8 Battleboar Flank##4849|q 780/2
	step //21
		ding 4
	step //22
		goto 44.7,76.2
	...
	step //23
		...
		.get Chief Sharptusk Thornmantle's Head##10459|q 3376/1
		.info He's standing in a huge round tent.
	step //24
		goto 58.2,84.9
		.from Bristleback Quillboar##2952, Bristleback Shaman##2953
		.get 8 Bristleback Belt##4770|q 757/1
	step //25
		goto 64.0,77.8
		.from Bristleback Shaman##2953
		.get 2 Ritual Salve##6634|q 1519/1
		only Tauren Shaman
	step //26
		ding 5
	step //27
		.' Hearth to Camp Narache|goto 44.9,77.2,0.1|use Hearthstone##6948|noway|q 780
	step //28
		goto 44.9,77.1
		.talk Grull Hawkwind##2980
	...
	step //42
		goto 46.6,61.1
		.talk Innkeeper Kauth##6747
		home Bloodhoof Village|q 766
	step //43
		goto 56.11,71.4
		.from Prairie Wolf##2958, Prairie Stalker##2959
		.get Prairie Wolf Heart##4804|q 766/1
		.from Flatland Cougar##3035
		.get Flatland Cougar Femur##4805|q 766/2
		.from Adult Plainstrider##2956, Elder Plainstrider##2957
		.get Plainstrider Scale##4806|q 766/3
		.from Wiry Swoop##2969, Swoop##2970
		.get Swoop Gizzard##4807|q 766/4
	step //44
		goto 52,63.6
		.collect 2 Ambercorn##4809|q 771/2
		.info They look like little brown pine cones on the ground around the trees.
		.' You can find more Ambercorn (1)|at 50.35,66.5
		.' You can find more Ambercorn (2)|at 47.8,68.23
		.' You can find more Ambercorn (3)|at 44.85,70.18
		.' You can find more Ambercorn (4)|at 55.97,62.37
		.' You can find more Ambercorn (5)|at 57.75,64.9
	step //45
		ding 6
	step //46
		goto 53.3,65.7
		.collect 2 Well Stone##4808|q 771/1
		.info They look like flat grey rocks laying around this well.
	step //47
		goto 52,66.9
		.from Prairie Wolf##2958, Prairie Stalker##2959
		.get 6 Prairie Wolf Paw##4758|q 748/1
		.from Adult Plainstrider##2956, Elder Plainstrider##2957
		.get 4 Plainstrider Talon##4759|q 748/2
		only Tauren
	step //48
		goto 52.8,71.2
		.kill 10 Palemane Tanner##2949|q 745/1
		.kill 8 Palemane Skinner##2950|q 745/2
		.kill 5 Palemane Poacher##2951|q 745/3
		.' You can find more around|at 48.33,71.95
	step //49
		goto 56.1,71.4
		.from Wiry Swoop##2969, Swoop##2970
		.get 8 Trophy Swoop Quill##4769|q 761/1
	step //50
		ding 7
	step //51
		goto 48.5,60.4
	...
	step //56
		...
		.info Stand next to the windmill.
	...
	step //61
		goto 35.4,35.8
		.from Flatland Cougar##3035
		.get 6 Cougar Claws##4802|q 756/2
		.from Prairie Stalker##2959
		.get 6 Stalker Claws##4801|q 756/1
		only Tauren
	step //62
		goto 34.7,46.9
	...
	step //63
		...
		.info Stand next to the forge.
		.get 5 Broken Tools##4703|q 746/1
	step //64
		.' Hearth to Bloodhoof Village|goto 46.7,61.0,0.1|use Hearthstone##6948|noway|q 746
	step //65
		goto 47.5,60.2
		.talk Baine Bloodhoof##2993
	...
	step //75
		goto 53.7,48.2
		.' Interact with gameobject: Sealed Supply Crate
	...
	step //77
		...
		.get 8 Windfury Talon##4751|q 743/1
	step //78
		.' Hearth to Bloodhoof Village|goto 46.7,61.0,0.1|use Hearthstone##6948|noway|q 743
	step //79
		goto 47.4,62
		.talk Ruul Eagletalon##2985
	...
	step //81
		...
		only Tauren Warrior
	step //82
		.' Go southeast to the Barrens|goto The Barrens|q 1505
		only Tauren Warrior
	step //83
	...
	step //87
		...
		only Tauren Warrior
	step //88
		.' Go southwest to Mulgore|goto Mulgore|q 759
		only Tauren Warrior
	step //89
		goto 48.3,59.1
		...
		only Tauren Shaman
	step //90
		.' Go east to the Barrens|goto The Barrens|q 2984
		only Tauren Shaman
	step //91
	...
	step //93
		...
		.' The path up to Telf Joolam starts here|goto Durotar,37.0,57.0,1|q 1524
	...
	step //110
		...
		only Tauren Hunter
	step //111
		.' Go northwest to Thunder Bluff|goto Thunder Bluff|q 6089
		only Tauren Hunter
	step //112
		...
		only Tauren Hunter
	step //113
		.' Go outside of Thunder Bluff|goto Mulgore|q 759
		only Tauren Hunter
	step //114
		goto 48.5,59.7
		...
		only Tauren Druid
	step //115
		.' Go to Thunder Bluff|goto Thunder Bluff|q 5926
		only Tauren Druid
	step //116
	...
	step //117
		...
		.' Cast your Teleport: Moonglade spell to teleport to Moonglade|goto Moonglade|cast Teleport: Moonglade##18960|q 5922
		only Tauren Druid
	step //118
	...
	step //121
		...
		.' Fly to Thunder Bluff|goto Thunder Bluff|q 5932
		only Tauren Druid
	step //122
		goto Thunder Bluff,76.4,27.3
		.talk Turak Runetotem##3033
		...
		only Tauren Druid
	step //123
		.' Go outside to Mulgore|goto Mulgore|q 6002
		only Tauren Druid
	step //124
		.' Go southeast to the Barrens|goto The Barrens|q 6002
		only Tauren Druid
	step //125
	...
	step //
		...
		.fpath Camp Taurajo|q 6002
		only Tauren Druid
	step //127
		goto The Barrens,44.4,59.2|n
		.talk Omusa Thunderhorn##10378
		.' Fly to Thunder Bluff|goto Thunder Bluff|q 6002
		only Tauren Druid
	step //128
		goto Thunder Bluff,76.4,27.3
		.talk Turak Runetotem##3033
		...
		only Tauren Druid
	step //129
		.' Go outside to Mulgore|goto Mulgore|q 759
		only Tauren Druid
	step //130
		goto Mulgore,63.2,61.7
		.from Prairie Wolf Alpha##2960
		.get 8 Prairie Alpha Tooth##4803|q 759/1
		only Tauren
	step //131
		goto 48.5,60.4
		.talk Mull Thunderhorn##2948
	...
	step //133
		goto 59.2,48.8
		.kill 14 Venture Co. Worker##2978|q 764/1
		.kill 6 Venture Co. Supervisor##2979|q 764/2
	step //134
		...
		.get Fizsprocket's Clipboard##4819|q 765/1
	step //135
		goto 59.3,62.2
		.talk Morin Cloudstalker##2988
	...
	step //136
		ding 11
	step //137
		.' Go northwest to Thunder Bluff|goto Thunder Bluff|q 744 |future
	step //138
		goto Thunder Bluff,37.7,59.6
		.talk Eyahn Eagletalon##2987
		..accept Preparation for Ceremony##744
	step //139
		.' Leave Thunder Bluff|goto Mulgore|q 744
	step //140
	...
	step //144
		...
		.get 4 Flatland Prowler Claw##5203|q 861/1
	step //145
		goto 42.7,14.1
	...
	step //146
		...
		.get 6 Azure Feather##4752|q 744/1
		.get 6 Bronze Feather##4753|q 744/2
	step //147
		.' Go southeast to Thunder Bluff|goto Thunder Bluff|q 744
	step //148
		goto Thunder Bluff,37.7,59.6
		.talk Eyahn Eagletalon##2987
	...
	step //151
		.' Leave Thunder Bluff|goto Mulgore|q 776
	step //152
		goto Mulgore,51,12.6
		.from Arra'chea##3058
		.get Horn of Arra'chea##4841|q 776/1
	step //153
		goto 37.3,14.2
		.from Ghost Howl##3056
		.collect Demon Scarred Cloak##4854|q 770 |future
	step
		.use Demon Scarred Cloak##4854
		..accept The Demon Scarred Cloak##770
	step //154
		.' Go southeast to Thunder Bluff|goto Thunder Bluff|q 776
	step //155
		goto Thunder Bluff,60.3,51.6
		.talk Cairne Bloodhoof##3057
		..turnin Rites of the Earthmother##776
	step //156
		.' Hearth to Bloodhoof Village|goto Mulgore,46.7,61.0,0.1|use Hearthstone##6948|noway|q 770
	step //157
	...
	step //159
		...
		only Tauren
	step //160
		.' Go east to the Barrens|goto The Barrens|q 860
	step //161
		goto The Barrens,44.4,59.2
		.talk Omusa Thunderhorn##10378
		.fpath Camp Taurajo|q 860
	step //162
		goto 44.9,58.6
	...
	step //165
		goto 51.5,30.3
		.talk Devrak##3615
		.fpath Crossroads|q 447 |future
	step //166
		goto 52.0,29.9
		.talk Innkeeper Boorand Plainswind##3934
		home The Crossroads|q 447 |future
	step //167
		.' Go northeast to Durotar|goto Durotar|q 447 |future
	step //168
		.' Go northeast to Orgrimmar|goto Orgrimmar|q 447 |future
	step //169
		goto Orgrimmar,45.1,63.9
		.talk Doras##3310
		.fpath Orgrimmar|q 447 |future
	step //170
		.' Go outside of Orgrimmar|goto Durotar|q 447 |future
	step //171
		goto 50.8,13.3|n
		.' Ride the zeppelin to Undercity|goto Tirisfal Glades|q 447 |future
	...
	step //191
		...
		..turnin A Recipe For Death (1)##447
	step //192
		.' Hearth to the Crossroads|goto The Barrens,52.0,29.9,0.1|use Hearthstone##6948|noway|q 840 |future
	step //193
		.' Go northeast to Durotar|goto Durotar|q 840 |future
	step //194
		goto Durotar,50.8,43.6
		.talk Takrin Pathseeker##3336
		..accept Conscript of the Horde##840
...
startlevel 13
	...
	step
		goto 52.0,29.9
		.talk Innkeeper Boorand Plainswind##3934
		.home The Crossroads|q 842 |future
	step
		goto 51.5,30.3
		.talk Devrak##3615
		.fpath Crossroads
	...
	step
		goto Thunder Bluff,47,49.9
		.talk Tal##2995
		.' Fly to the Crossroads|goto The Barrens,51.5,30.4,1|noway|q 886
	step //4
	...
	step //9
		goto 51.5,30.3
		.talk Devrak##3615
		.' Fly to Orgrimmar|goto Orgrimmar|q 6384
		only Orc,Troll
	step //10
	...
	step //12
		goto 45.1,63.9
		.talk Doras##3310
		.' Fly to the Crossroads|goto The Barrens,51.5,30.4,1|noway|q 871 |future
		only Orc,Troll
	step //13
	...
	step //18
		...
		.get 7 Plainstrider Beak##5087|q 844/1
	step //19
		goto 59.2,24.4
		.collect Crossroads' Supply Crates##12708|q 5041/1
		.info They look like a pile of brown boxes.
	step //20
		goto 54.2,25.3
	...
	step //21
		...
		.get 12 Raptor Head##5062|q 869/2
	...
	step //47
		...
		.get 4 Zhevra Hooves##5086|q 845/1
	step
		goto 45.05,22.53
		.goal Explore the waters of the Forgotten Pools|q 870/1
		.info Swim underwater to the bubbles.
	step //48
		goto 45.3,22.9
		.collect 4 Fungal Spores##5012|q 848/1
		.info They look like big blue mushrooms around the lake.
	step //49
		goto 42.6,23.4
		.from Barak Kodobane##3394
		.get Barak's Head##5022|q 850/1
	step //50
		goto 46.1,26
		.from Kolkar Wrangler##3272, Kolkar Stormer##3273
		.get 15 Centaur Bracers##5030|q 855/1
	step //51
		goto 40.7,19.7
	...
	step //58
		...
		.get Kreenig Snarlsnout's Tusk##5063|q 872/3
		.info Kreenig Snarlsnout walks around this area.
	step //59
		goto 56.4,24.2
		.kill 8 Razormane Geomancer##3269|q 872/1
		.kill 8 Razormane Defender##3266|q 872/2
	step //60
		goto 62.7,36.2
		.talk Gazlowe##3391
	...
	step
		goto 63.1,37.2|n
		.talk Bragok##16227
		.' Fly to Orgrimmar|goto Orgrimmar|q 1061 |future
	step
	...
	step
		...
		.talk Doras##3310
		.' Fly to Ratchet|goto The Barrens,63.09,37.17,1|noway|q 894 |future
	step //62
	...
	step //75
		goto 63.1,37.2|n
		.talk Bragok##16227
		.' Fly to the Crossroads|goto The Barrens,51.5,30.4,0.1|noway|q 872
	step //76
		goto 51.5,30.9
		.talk Thork##3429
	...
	step //79
		.' Go west to Stonetalon Mountains|goto Stonetalon Mountains|q 6548
	step //80
		goto Stonetalon Mountains,80.6,90.3
		.kill 8 Grimtotem Ruffian##11910|q 6548/1
		.kill 6 Grimtotem Mercenary##11911|q 6548/2
	step //81
		.' Go southeast to the Barrens|goto The Barrens|q 6548
	step //82
	...
	step //83
		.' Go west to Stonetalon Mountains|goto Stonetalon Mountains|q 6629
	step //84
		goto 73.7,86.1
		.kill 1 Grundig Darkcloud##11858|q 6629/1
		.info He's standing on the steps of a teepee.
	step //85
		goto Stonetalon Mountains,71.5,88
		.kill 6 Grimtotem Brute##11912|q 6629/2
	step //86
		.' Go southeast to the Barrens|goto The Barrens|q 6629
	step //87
		goto The Barrens,35.2,27.8
		.talk Makaba Flathoof##11857
	...
	step //88
		ding 16
	step //89
		.' Hearth to the Crossroads|goto The Barrens,52.0,29.9,0.5|use Hearthstone##6948|noway|q 422 |future
	step //90
	...
	step //110
		...
		only Tauren Druid
	step //111
		goto The Barrens,51.5,30.3|n
		.talk Devrak##3615
		.' Fly to Orgrimmar|goto Orgrimmar|q 422 |future
	step //112
		goto Durotar,51,14|n
		.' Ride the zeppelin to Undercity|goto Tirisfal Glades|noway|q 422 |future
	step //113
		goto Undercity,48.8,69.3
		.talk Master Apothecary Faranell##2055
	...
	step //114
		...
		.talk Michael Garrett##4551
		.' Fly to the Sepulcher|goto Silverpine Forest,45,42,1|noway|q 422 |future
	step //115
	...
	step //120
		goto 58.4,34.8
		.' Interact with gameobject: Corpse Laden Boat
	...
	step //123
		...
		.get 8 Rot Hide Ichor##3236|q 443/1
	step //124
		goto 54.7,48.4
		.from Moonrage Glutton##1779
		.get 6 Glutton Shackle##3156|q 423/1
	step //125
		goto 56.5,46
		.info Go inside the mine.
		.from Moonrage Darksoul##1782
		.get 3 Darksoul Shackle##3157|q 423/2
	step //126
		.' Leave the mine|goto 56.5,46.0,0.5|q 477
	step //127
		goto 49.9,60.5
		.' Interact with gameobject: Dalaran Crate
		..turnin Border Crossings##477
		..accept Maps and Runes##478
	step //128
		goto 43.0,73.3
		.collect Berard's Journal##3255|q 450/1
		.info This is a bookshelf, on the second floor of the former tavern, in the far bedroom.
	step //129
		ding 17
	step //130
		.' Hearth to the Sepulcher|goto 43.2,41.4|use Hearthstone##6948|noway|q 443
	step //131
		goto 42.8,40.9
		.talk Apothecary Renferrel##1937
	...
	step //135
		...
		.get 6 Lake Skulker Moss##3256|q 451/1
	step //136
		goto 76.6,32.3
		...
		.get Hardened Tumor##3258|q 451/3
	step //137
		goto 77.8,27.0
		.from Lake Creeper##1955+, Elder Lake Creeper##1956+
		.get 6 Lake Creeper Moss##3257|q 451/2
	step //138
		goto 56.5,46
		.info Go inside the mine.
		.from Grimson the Pale##1972
		.get Head of Grimson##3634|q 424/1
	step //140
		goto 44.2,39.8
		.talk Dalar Dawnweaver##1938
	...
	step //141
		...
		.get 8 Dalaran Pendant##3354|q 479/1
	step //142
		goto 47.9,72.1
		.from Moonrage Watcher##1892+, Moonrage Sentry##1893+, Pyrewood Sentry##1894+, Moonrage Elder##1896+
		.get 6 Pyrewood Shackle##3218|q 99/1
	step //143
		.' Hearth to the Sepulcher|goto 43.2,41.4|use Hearthstone##6948|noway|q 479
	step //144
		goto 44.0,40.9
		.talk Shadow Priest Allister##2121
	...
	step //147
		goto 45.6,42.6|n
		.talk Karos Razok##2226
		.' Fly to Undercity|goto Undercity|q 444
	step //148
		goto 84.1,17.4
		.talk Bethor Iceshard##1498
	...
	step //150
		.' Go outside of the Undercity|goto Tirisfal Glades|q 6541 |future
	step //151
		goto Tirisfal Glades,60.8,58.8|n
		.' Ride the zeppelin to Orgrimmar|goto Durotar,50.8,13.2,1|noway|q 6541 |future
		.info You can ride this zeppelin to Orgrimmar or Grom'Gol Base Camp.
	step //152
		.' Go northwest to Orgrimmar|goto Orgrimmar|q 6541 |future
	step //153
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to the Crossroads|goto The Barrens,51.7,30.2,2|noway|q 6541 |future
    step //154
		goto The Barrens,52,29.9
		.talk Innkeeper Boorand Plainswind##3934
		home The Crossroads|q 6541 |future
	step //155
		goto 51.5,30.9
		.talk Thork##3429
	...
	step
		goto 51.5,30.3|n
		.talk Devrak##3615
		.' Fly to Thunder Bluff|goto Thunder Bluff|q 853
	step
		goto Thunder Bluff,22.8,20.9
		.talk Apothecary Zamah##3419
		..turnin Apothecary Zamah##853
	step
		.' Hearth to the Crossroads|goto The Barrens,52,29.9,0.1|use Hearthstone##6948|noway|q 4921
	step //158
		goto The Barrens,49.3,50.3
		.' Interact with gameobject: Beaten Corpse
	...
	step
		goto The Barrens,44.4,59.2|n
		.talk Omusa Thunderhorn##10378
		.' Fly to the Crossroads|goto The Barrens,51.5,30.3,1|noway|q 4921
	step //167
	...
	step //168
		...
		.get 7 Prowler Claws##5096|q 903/1
	step //169
		goto 39.9,17.2
		.from Witchwing Slayer##3278+
		.get 6 Harpy Lieutenant Ring##5065|q 875/1
	step //170
		goto 45.5,13.9
		.from Sunscale Scytheclaw##3256+
		.get 5 Intact Raptor Horn##5055|q 865/1
		.' You can find more raptors|at 52.3,47
	step //171
		goto 52.4,11.6
	...
	step //172
		goto 52.3,11.6
		.' Interact with gameobject: Main Control Valve
	...
	step //187
		goto 52.9,41.8
		.' Kill centaurs until a centaur says 'I am slain! Summon Verog!' as it dies.
		.info Kill centaurs around this area until you see one say "I am slain! Summon Verog!", then manually skip to the next step.
		.from Verog the Dervish##3395
		.get Verog's Head##5023|q 851/1
	step //188
		goto 52.3,31.9
		.talk Tonga Runetotem##3448
	...
	step //191
		...
		.info Use the Horn of Echeyakee to summon him.
		.from Echeyakee##3475
		.get Echeyakee's Hide##5100|q 881/1
	step //192
		goto 49.0,11.2
	...
	step //193
		goto 56.7,8.8
		.collect 15 Nugget Slug##11143|q 3922/1
		.info It looks like an iron bucket with various tools inside.
	step //194
		goto 49.0,11.2
		.talk Wenikee Boltbucket##9316
	...
	step //196
		...
		.get Serena's Head##5067|q 876/1
	step //197
		.' Hearth to the Crossroads|goto The Barrens,52.0,29.9,0.1|use Hearthstone##6948|noway|q 881
	step //198
		goto 52.2,31
		.talk Sergra Darkthorn##3338
...
startlevel 30
	step //1
		.' Hearth to Sun Rock Retreat|goto Stonetalon Mountains,47.5,62.1,0.5|use Hearthstone##6948|noway|q 494 |future
	step //2
		goto 45.1,59.8|n
		.talk Tharm##4312
		.' Fly to Orgrimmar|goto Orgrimmar|q 494 |future
	step //3
		...
		only Warrior
	step //4
		.' Fly to Ratchet|goto The Barrens,63.1,37.1,0.1|noway|q 1718
		only Warrior
	step //5
	...
	step //7
		...
		only Warrior
	step //8
		.' Go to Ratchet and fly to Orgrimmar|goto Orgrimmar|q 494 |future
		only Warrior
	step //9
		...
		only Shaman
	step //10
		.' Fly to Freewind Post|goto Thousand Needles,45.0,49.1,0.1|noway|q 1531
		only Shaman
	step //11
		goto Thousand Needles,54.6,44.7|n
		.' The path up Prate Cloudseer starts here|goto Thousand Needles,54.6,44.7,0.3|noway|q 1531
		only Shaman
	step //12
		...
		only Shaman
	step //13
		.' Go southwest to Freewind Post and fly to Orgrimmar|goto Orgrimmar|q 494 |future
		only Shaman
	step //14
		goto Orgrimmar,54.1,68.4
		.talk Innkeeper Gryshka##6929
		home Orgrimmar|q 494 |future
	step //15
		.' Go outside to Durotar|goto Durotar|q 494 |future
	step //16
		goto Durotar,50.82,13.52|n
		.' Ride the zeppelin to Undercity|goto Tirisfal Glades|noway|q 494 |future
		.info You can ride zeppelins to either Undercity or the Grom'Gol Base Camp here.
	step //17
		.' Go to the Undercity|goto Undercity|q 494 |future
	step //18
		goto Undercity,63.3,48.6|n
		.talk Michael Garrett##4551
		.' Fly to The Sepulcher|goto Silverpine Forest,45.6,42.4,0.1|noway|q 494 |future
	step //19
		.' Go south to Hillsbrad Foothills|goto Hillsbrad Foothills,13.8,45.8,0.5|noway|q 494 |future
	step //20
	...
	step //27
		goto 48.1,31.4
		.from Cave Yeti##2248, Ferocious Yeti##2249, Mountain Yeti##2250
		.get Helcular's Rod##3708|q 552/1
	step //28
		goto Hillsbrad Foothills,52.3,33.0
		.from Starving Mountain Lion##2384
		.get 10 Mountain Lion Blood##3496|q 501/1
	step //29
	...
	step //31
		.' Go southeast to Arathi Highlands|goto Arathi Highlands,20.0,29.3,0.2|q 655 |future
	step //32
		goto Arathi Highlands,73,32.7
		.talk Urda##2851
		.fpath Hammerfall
	...
	step //35
		goto 69.9,36.2
		.from Highland Strider##2559, Highland Thrasher##2560
		.get 10 Highland Raptor Eye##4512|q 672/1
	step //36
		goto 74.7,36.3
		.talk Tor'gan##2706
	...
	step //39
		.' Hearth to Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 583 |future
	step //40
		.' Go outside to Durotar|goto Durotar|q 583 |future
	step //41
		goto Durotar,50.8,13.3|n
		.' Ride the zeppelin to Grom'Gol Base Camp|goto Stranglethorn Vale|noway|q 583 |future
		.info You can ride zeppelins to either Undercity or the Grom'Gol Base Camp here.
	step //42
	...
	step //50
		ding 31
	step //51
		.' Hearth to Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 1361
	step //52
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to the Crossroads|goto The Barrens,53.43,53.97,0.5|noway|q 1361
	step //53
	...
	step //55
		goto 51.5,30.3|n
		.talk Devrak##3615
		.' Fly to Freewind Post|goto Thousand Needles,45.0,49.1,0.1|noway|q 1105 |future
	step //56
	...
	step //68
		.' Go southwest to Tanaris|goto Tanaris|q 1145
	step //69
	...
	step //74
		.' Go outside to Durotar|goto Durotar|q 676
	step //75
		goto Durotar,51,14|n
		. Ride the zeppelin to Undercity|goto Tirisfal Glades,60.7,58.8,2|noway|q 676
	step //76
		.' Go to the Undercity|goto Undercity|q 676
	step //77
		goto Undercity,63.3,48.6|n
		.talk Michael Garrett##4551
		.' Fly to Tarren Mill|goto Hillsbrad Foothills,61.4,23.0,4|noway|q 676
	step //78
		goto Arathi Highlands,30.9,48.4
		.kill 8 Boulderfist Ogre##2562|q 676/1
	step //79
		goto 35.1,44.3
		.kill 10 Boulderfist Enforcer##2564|q 676/2
		.info Inside the cave.
	step //80
		goto 74.2,33.9
		.talk Drum Fel##2771
	...
	step //81
		goto 73.1,32.7|n
		.talk Urda##2851
		.' Fly to Undercity|goto Undercity|q 194
	step //82
		.' Go outside of Undercity|goto Tirisfal Glades|q 194
	step //83
		goto Tirisfal Glades,62,59.1|n
		.' Ride the zeppelin to Grom'Gol Base Camp|goto Stranglethorn Vale,31.9,28.4,3|noway|q 194
	step //84
	...
	step //87
		.' Go to Grom'Gol Base Camp|goto Stranglethorn Vale,31.9,28.4,3|q 5561 |future
	step //88
		goto 31.4,30.1|n
		.' Ride the zeppelin to Orgrimmar|goto Durotar,50.8,13.2,1|noway|q 5561 |future
	step //89
		.' Go to Orgrimmar|goto Orgrimmar|noway|q 5561 |future
	step //90
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to Sun Rock Retreat|goto Stonetalon Mountains,45.2,59.9,0.1|noway|q 5561 |future
	step //91
		.' Go southwest to Desolace|goto Desolace|q 5561 |future
	step //92
		goto Desolace,57.8,21.7
		.from Burning Blade Reaver##4664, Burning Blade Adept##4665, Burning Blade Felsworn##4666
		.collect Flayed Demon Skin##20310|q 1480 |future
	step
	...
	step //99
		goto 72.3,23.6
		.kill 7 Hatefury Rogue##4670|q 1434/1
		.kill 7 Hatefury Felsworn##4672|q 1434/2
		.kill 7 Hatefury Betrayer##4673|q 1434/3
		.kill 7 Hatefury Hellcaller##4675|q 1434/4
		.from Hatefury Shadowstalker##4674
		.get Shadowstalker Scalp##6441|q 1481/1
	step //100
		goto 73.8,67
	...
	step //107
		goto 73.4,41.6
		.from Khan Dez'hepah##5600
		.get Khan Dez'hepah's Head##6066|q 1365/1
	...
	step //113
		...
		home Shadowprey Village|q 5763
	step //114
		goto 23.3,72.9
	...
	step //124
		...
		.get 15 Infused Burning Gem##6435|q 1435/1
	step //125
		goto 55.2,30.1
	...
	step //127
		goto 37.3,18.1
		.from Slitherblade Oracle##4718
		.get Oracle Crystal##6442|q 1482/1
	step //128
		goto 32.8,14.9
	...
	step //133
		...
		.get 15 Centaur Ear##6067|q 1366/1
	step //134
		goto 70.9,75.4
	...
	step //137
		...
		.from Demon Spirit##11876
		.get Demon Box##13542|q 5381/1
	step //138
		goto 28.2,6.6
	...
	step //140
		.' Hearth to Shadowprey Village|goto 24.1,68.2,0.1|use Hearthstone##6948|noway|q 5381
	step //141
		goto 25.8,68.2
		.talk Taiga Wisemane##11624
	...
	step //146
		goto Desolace,21.6,74.1|n
		.talk Thalon##6726
		.' Fly to Freewind Post|goto Thousand Needles,45.0,49.1,0.3|noway|q 1175
	step //147
	...
	step //151
		goto Tanaris,51.6,25.4|n
		.talk Bulkrek Ragefist##7824
		.' Fly to Camp Taurajo|goto The Barrens,44.5,59.1,0.1|noway|q 11124 |future
	step //152
		.' Go to Dustwallow Marsh|goto Dustwallow Marsh|q 11124 |future
	step
	...
	step //153
		...
		.' Interact with gameobject: Hoofprints
	...
	step //159
		goto 35.6,31.9|n
		.talk Shardi##11899
		.' Fly to Ratchet|goto The Barrens,63.1,37.1,0.1|noway|q 1178
	step //160
		goto The Barrens,62.7,36.2
		.talk Gazlowe##3391
	...
	step //171
		goto 26.9,77.1|n
		.talk Gringer##2858
		.' Fly to Grom'gol Base Camp|goto Stranglethorn Vale,32.5,29.3,0.1|noway|q 605
	step //172
		goto 32.1,29.2
	...
	step //177
		goto 28.8,19.7
		.' Kill Trolls|n
		.get 9 Bloodscalp Tusk##3901|q 581/1
		.get 15 Bloodscalp Ear##1519|q 189/1
		.get 25 Bloody Bone Necklace##3915|q 596/1
		.from Bloodscalp Shaman##697
		.get Bloodscalp Totem##23679|q 9436/1
	step //178
		ding 35
]])
...
startlevel 35
	...
	step //2
		goto 32.4,21.3
		.kill 15 Lashtail Raptor##686|q 568/1
	step //3
		goto 32.2,27.7
		.talk Nimboya##2497
	...
	step //6
		goto 20.1,14
		.from Bloodscalp Headhunter##671
		.get 20 Shrunken Head##1532|q 582/1
	step //7
		goto 35.7,10.8
		.talk Hemet Nesingwary Jr.##715
	...
	step //10
		goto 37.4,29.3
		.kill 10 Mosh'Ogg Brute##1142|q 569/1
		.kill 5 Mosh'Ogg Witch Doctor##1144|q 569/2
	step //11
		goto 32.2,28.9
		.talk Commander Aggro'gosh##2464
	...
	step //13
		.' Hearth to Booty Bay|goto 27.1,77.3,0.1|use Hearthstone##6948|noway|q 605
	step //14
		goto 27.1,77.2
		.talk Crank Fizzlebub##2498
	...
	step //19
		goto 26.9,77.1|n
		.talk Gringer##2858
		.' Fly to Grom'gol Base Camp|goto Stranglethorn Vale,32.5,29.3,0.1|noway|q 638
	step //20
		goto 31.55,29.15|n
		.' Ride the zeppelin to Undercity|goto Tirisfal Glades|q 638
	step //21
		.' Go south to Undercity|goto Undercity|q 638
	step //22
	...
	step //23
		goto Undercity,63.3,48.6|n
		.talk Michael Garrett##4551
		.' Fly to Hammerfall|goto Arathi Highlands,73.1,32.6,0.1|noway|q 638
	step //24
	...
	step //27
		goto 70.2,58.9
		.kill 10 Witherbark Axe Thrower##2554|q 677/1
		.kill 10 Witherbark Headhunter##2556|q 677/2
		.kill 8 Witherbark Witch Doctor##2555|q 677/3
	step //28
		goto 62.5,33.8
	...
	step //30
		...
		home Hammerfall|q 642
	step //31
		goto 80.9,39.9|n
		.' The path up to 'The Princess Trapped' starts here|goto Arathi Highlands,80.9,39.9,0.5|noway|q 642
	step //32
		goto 82.6,36.5
	...
	step //34
		...
		.get Kenata's Head##5830|q 1164/1
	step //35
		goto 54.2,38.3
		.from Marcel Dabyrie##4481
		.get Marcel's Head##5832|q 1164/2
		.info Standing inside the stables.
	step //36
		goto 56.7,40.4
		.from Fardel Dabyrie##4479
		.get Fardel's Head##5831|q 1164/3
		.info Standing in front of the barn.
	step //37
		goto 52.3,67.4
		.from Highland Fleshstalker##2561
		.get 12 Raptor Heart##4513|q 701/1
		.' You can find more around|at 47.15,78.65
	step //38
		goto 53,72.8
		.kill 10 Boulderfist Brute##2566|q 678/1
		.kill 4 Boulderfist Magus##2567|q 678/2
	step //39
		goto 26,62
		.from Syndicate Prowler##2588, Syndicate Conjuror##2590, Syndicate Magus##2591, Syndicate Thief##24477
		.get Sigil of Strom##4440|q 639/1
	step //40
		goto 34.1,31.6
		.from Syndicate Highwayman##2586, Syndicate Pathstalker##2587, Syndicate Mercenary##2589
		.get 10 Bloodstone Amulet##4495|q 671/1
	step //41
		.' Hearth to Hammerfall|goto 73.8,32.6,0.1|use Hearthstone##6948|noway|q 639
	step //42
		goto 73.8,34
		.talk Zengu##2703
	...
	step //48
		goto 73.1,32.7|n
		.talk Urda##2851
		.' Fly to Tarren Mill|goto Hillsbrad Foothills,60.2,18.8,0.1|noway|q 544 |future
	step //49
	...
	step //50
		.' Go northwest to Alterac Mountains|goto Alterac Mountains|q 556
	step //51
		goto Alterac Mountains,17.2,74.7
		.from Dalaran Shield Guard##2271, Dalaran Theurgist##2272, Dalaran Summoner##2358
		.get 10 Worn Stone Token##3714|q 556/1
	step //52
		goto 20.1,84.1
		.from Ricter##2411
		.get Bloodstone Marble##3689|q 544/2
		.info Standing to the right as you enter the camp.
	step //53
		goto 20.2,86.4
		.from Alina##2412
		.get Bloodstone Shard##3690|q 544/3
		.from Dermot##2413
		.get Bloodstone Wedge##3691|q 544/1
		.info Standing inside the long house.
	step //54
		goto 17.8,83.2
		.from Kegan Darkmar##2414
		.get Bloodstone Oval##3688|q 544/4
		.info Standing upstairs in the big house.
	step //55
		.' Go southeast to Hillsbrad Foothills|goto Hillsbrad Foothills|q 553
	step //56
		.' Go inside the yeti cave|goto Hillsbrad Foothills,46.2,31.8,0.5|q 553
	step //57
		goto Hillsbrad Foothills,43.9,28.1
		.' Interact with gameobject: Flame of Azel
		.goal Flame of Azel charged|q 553/1
		.info Follow the path to the right.
	step //58
		goto Hillsbrad Foothills,44.1,26.5
		.' Interact with gameobject: Flame of Veraz
		.goal Flame of Veraz charged|q 553/2
	...
	step //61
		.' Go north to Alterac Mountains|goto Alterac Mountains|q 1136
	step //62
		goto Alterac Mountains,37.5,66.3
		.' Interact with gameobject: Flame of Uzel
		.goal Flame of Uzel charged|q 553/3
	step
		goto Alterac Mountains,37.5,66.3
		.use Fresh Carcass##5810
		.info Use your Fresh Carcass next to the Flame of Uzel.
		.from Frostmaw##4504
		.info Frostmaw will walk to the mouth of the cave from outside.
		.get Frostmaw's Mane##5811|q 1136/1
		.info Inside a small cave.
	step //63
		goto 20,74
		.kill 6 Dalaran Summoner##2358|q 545/1
		.kill 12 Elemental Slave##2359|q 545/2
		.from Elemental Slave##2359
		.get 4 Bracers of Earth Binding##3715|q 557/1
	step //64
		.' Go to southeast to Hillsbrad Foothills|goto Hillsbrad Foothills|q 545
	step //65
		goto Hillsbrad Foothills,61.6,20.8
		.talk Magus Wordeen Voidglare##2410
	...
	step //66
		goto 52.7,53.4
		.' Interact with gameobject: Helcular's Grave
		..turnin Helcular's Revenge (2)##553
		.info It's a tombstone in the graveyard on the side closest to the river.
	step //67
		goto Hillsbrad Foothills,60.1,18.6|n
		.talk Zarise##2389
		.' Fly to Undercity|goto Undercity|q 1164
	step //68
		goto Undercity,63.8,49.5
		.talk Genavie Callow##4486
		..turnin To Steal From Thieves##1164
	step //69
		.' Go outside of Undercity|goto Tirisfal Glades|q 570
	step //70
		goto 61.9,59.1|n
		.' Ride the zeppelin to Grom'Gol Base Camp|goto Stranglethorn Vale,31.9,28.4,3|q 570
	step //71
		goto 19.8,22.6
		.use Gift of Naias##23680
		.info Use your Gift of Naias while standing next to the Altar of Naias.
		.info It looks like a stone box
		.from Naias##17207
		.get Heart of Naias##23681|q 9457/1
	step //72
		goto 24.8,23.1
		.collect Tablet Shard##4094|q 629/1
		.info It looks like a stone tablet leaning against a wall underwater.
	step //73
		goto 42.7,18.4
	...
	step //75
		...
		.from Shadowmaw Panther##684
		.get 8 Shadowmaw Claw##3838|q 570/1
		.from Stranglethorn Tigress##772
		.get Pristine Tigress Fang##3839|q 570/2
	step //76
		.' Go to Grom'Gol Base Camp|goto Stranglethorn Vale,31.9,28.4,3|q 570
	step //77
		goto 32.1,29.2
		.talk Far Seer Mok'thardin##2465
	...
	step //80
		goto 32.5,29.4|n
		.talk Thysta##1387
		.' Fly to Booty Bay|goto Stranglethorn Vale,27.7,74.6,6|noway|q 1182
	step //81
		goto 27.2,76.9
		.talk Baron Revilgaz##2496
	...
	step //83
		goto 25.75,73.05|n
		.' Ride the boat to Ratchet|goto The Barrens,63.1,37.1,5|noway|q 5361
	step //84
		goto The Barrens,63.1,37.2|n
		.talk Bragok##16227
		.' Fly to Shadowprey Village|goto Desolace,24,68,5|noway|q 5361
	step //85
		goto 55.4,55.8
		.talk Nataka Longhorn##11259
		..turnin Family Tree##5361
	step //86
		.' Hearth to Hammerfall|goto Arathi Highlands,73.8,32.6,0.5|use Hearthstone##6948|noway|q 651
	step //87
		goto 66.8,29.7
	...
	step //91
		goto 31.3,64.6|n
		.' The path over to Faldir's Cove starts here|goto Arathi Highlands,31.3,64.6,0.5|noway|q 663 |future
	step //92
		goto 31.8,82.7
	...
	step
		goto 35.75,79.58
		.goal Escort Professor Phizzlethorpe|q 665/1
	step
		goto 33.9,80.4
	...
	step //105
		.' Hearth to Hammerfall|goto 73.8,32.6,0.1|use Hearthstone##6948|noway|q 1146 |future
	step //106
		goto 73.1,32.7|n
		.talk Urda##2851
		.' Fly to Undercity|goto Undercity|q 1146 |future
	step //107
		.' Go outside of Undercity|goto Tirisfal Glades|q 1146 |future
	step //108
		goto Tirisfal Glades,60.8,58.8|n
		.' Ride the zeppelin to Orgrimmar|goto Durotar|noway|q 1146 |future
		.info You can ride this zeppelin to Orgrimmar or Grom'Gol Base Camp.
	step //109
		.' Go northwest to Orgrimmar|goto Orgrimmar|q 1146 |future
	step //110
		goto Orgrimmar,75.2,34.2
		.talk Belgrom Rockmaul##4485
	...
	step //111
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to the Crossroads|goto The Barrens,51.5,30.4,0.1|noway|q 1146
	step //112
		goto 52,29.9
		.talk Innkeeper Boorand Plainswind##3934
		home The Crossroads|q 1146
	step //113
		goto The Barrens,51.5,30.3|n
		.talk Devrak##3615
		.' Fly to Freewind Post|goto Thousand Needles,45.0,49.1,0.1|noway|q 1146
	step //114
	...
	step //115
		goto 68.3,81.2
		.kill 5 Silithid Searcher##4130|q 1147/1
		.kill 5 Silithid Hive Drone##4133|q 1147/2
		.kill 5 Silithid Invader##4131|q 1147/3
		.collect Cracked Silithid Carapace##5877|q 1148 |future
	step
		.use Cracked Silithid Carapace##5877
		..accept Parts of the Swarm (1)##1148
	step //116
		goto 68.4,85.8
		.from Silithid Searcher##4130, Silithid Invader##4131, Silithid Hive Drone##4133
		.get 1 Silithid Heart##5855|q 1148/1
		.get 5 Silithid Talon##5854|q 1148/2
		.get 3 Intact Silithid Carapace##5853|q 1148/3
	step //117
		goto 80.2,75.9
		.talk Pozzik##4630
	...
	step //123
		.' Hearth to the Crossroads|goto The Barrens,52.0,29.9,0.1|use Hearthstone##6948|noway|q 1148
	step //124
		goto The Barrens,51.1,29.6
		.talk Korran##3428
	...
	step //125
		goto 51.5,30.3|n
		.talk Devrak##3615
		.' Fly to Brackenwall Village|goto Dustwallow Marsh,35.6,31.8,0.1|noway|q 1201 |future
	step //126
	...
	step
		...
		.info Use your Ooze Buster on oozes.
	...
	step //143
		...
		.' You can find more around (1)|at 40.6,33.4
		.' You can find more around (2)|at 38.9,22.4
		.' You can find more around (3)|at 37.6,27
	step //144
		goto 46.6,24.4
		.talk Ithania##17119
	...
	step
		...
		.info The Warped Crates are at the top of the tower, it is a pile of brown boxes.
	step //145
		goto 55.4,26.3
	...
	step //149
		...
		.' You can find more around|at 51.15,27.8
	step //150
		goto 55.4,26.3
		.talk Mordant Grimsby##23843
	...
	step //151
		...
		.' You can find more around|at 51.45,17.99
	step //152
		goto 55.4,26.3
		.talk Mordant Grimsby##23843
	...
	step //153
		...
		.info Use the Witchbane Torch while standing at the end of the dock right outside.
		.from Zelfrax##23864
	...
	step
		goto Dustwallow Marsh,49.9,22.55
		.goal Help Stinky find Bogbean Leaves|q 1270/1
	step //156
		goto 34.9,22.7
		.from Darkmist Spider##4376, Darkmist Recluse##4378, Darkmist Silkspinner##4379
	...
	step //163
		goto 35.6,31.9|n
		.talk Shardi##11899
		.' Fly to Ratchet|goto The Barrens,63.1,37.1,0.1|noway|q 1270
	step //164
		goto 62.4,37.6
		.talk Mebok Mizzyrix##3446
	...
	step //165
		goto The Barrens,63.65,38.6|n
		.' Ride the boat to Booty Bay|goto Stranglethorn Vale|q 1115
	step //166
	...
	step //171
		goto 26.9,77.1|n
		.talk Gringer##2858
		.' Fly to Grom'gol Base Camp|goto Stranglethorn Vale,32.5,29.3,0.1|noway|q 1240
	step //172
		goto 32.2,27.7
		.talk Kin'weelay##2519
	...
	step
		goto 32.2,27.6
		.' Interact with gameobject: Bubbling Cauldron
...
startlevel 50
	...
	step //7
		goto 31,51
		.from Centipaar Wasp##5455, Centipaar Stinger##5456, Centipaar Swarmer##5457, Centipaar Worker##5458
		.get 5 Centipaar Insect Parts##8587|q 82/1
	step //8
	...
	step //16
		goto 55.7,70.3|n
		.' The path down to 'The Scrimshank Redemption' starts here|goto Tanaris,56.0,70.2,0.3|noway|q 10
	step //17
		goto 55.8,68.9|n
		.' Enter this tunnel heading north|goto Tanaris,55.8,68.9,0.3|noway|q 10
	step //18
		goto 56,71.2
	...
	step //24
		goto 51.6,25.4|n
		.talk Bulkrek Ragefist##7824
		.' Fly to Ratchet|goto The Barrens,63.1,37.1,0.1|noway|q 3444
	step //25
	...
	step //27
		goto 63.1,37.2|n
		.talk Bragok##16227
		.' Fly to Orgrimmar|goto Orgrimmar|q 4449 |future
	step //28
		goto Orgrimmar,55.8,64.8
		.talk Auctioneer Wabang##8724
	...
	step //31
		...
		.talk Gringer##2858
		.' Fly to Kargath|goto Badlands,4.1,44.9,0.3|noway|q 3441 |future
	step //32
		goto Badlands,4.5,61.3|n
		.' The path over to Searing Gorge starts here|goto Badlands,4.5,61.3,0.3|noway|q 3441 |future
	step //33
		.' Go west to Searing Gorge|goto Searing Gorge|q 3441 |future
	step //34
		goto Searing Gorge,31.8,33.4|n
		.' The path up to Thorium Point starts here|goto Searing Gorge,31.8,33.4,0.3|noway|q 3441 |future
	step //35
		goto 37.6,26.5
		.' Interact with gameobject: Wanted/Missing/Lost & Found Poster
	...
	step
		goto 39.1,39
		.talk Kalaran Windblade##8479
		.' Tell him: "Let me confer with my colleagues."
		.' Listen as Kalaran Windblade tells his story|q 3441/1
	step
		goto 39.1,39
		.talk Kalaran Windblade##8479
	...
	step //44
		goto 31,75
		.from Tempered War Golem##5853, Heavy War Golem##5854, Magma Elemental##5855
	...
	step
		...
		.info The book he slides under the door.
	step //48
		ding 51
	step //49
		goto 62,72
		...
		.' You can also find more spiders around|at 64,50.5
	...
	step //53
		goto 41.4,53.9|n
		.' The entrance to the Slag Pit starts here|goto Searing Gorge,41.4,53.9,0.5|noway|q 7701
		.info It's up on the metal riser walkway things.
	step //54
		.' Follow the path.
		.' Go through the Jail Door|goto Searing Gorge,37.6,44.3,0.5|q 7701
	step //55
		.' While in the Slag Pit:
		.kill 15 Dark Iron Taskmaster##5846|q 7729/1
		.kill 15 Dark Iron Slaver##5844|q 7729/2
	step //56
		.' Go up the big metal ramp into the big room|goto Searing Gorge,44.2,24.4,0.5|q 7701
	step //57
		goto 40.9,35.8
		.from Overseer Maltorius##14621
		.get Head of Overseer Maltorius##18946|q 7701/1
	step //58
		goto 40.5,35.7
		.' Interact with gameobject: Secret Plans: Fiery Flux
	...
	step //65
		goto 26,34
		.from Twilight Dark Shaman##5860, Twilight Fire Guard##5861
	...
	step
		goto 39.1,39
		.talk Kalaran Windblade##8479
		.' Tell him: "Kalaran, please enchant the torch."
		.' Wait for Kalaran Windblade to complete the Torch of Retribution|q 3453
	step
		goto 39.1,39
		.talk Kalaran Windblade##8479
	...
	step
		...
		.info The staff soaring in the sky.
	...
	step //67
		...
		.' Equip the Torch of Retribution|q 3463
	step //68
		goto 33.3,54.5
		.' Intetact with gameobject: Sentry Brazier
	...
	step
		...
		.info The small grey chest on the ground.
		..accept Trinkets...##3481
		..turnin Trinkets...##3481
	step
		.use Hoard of the Black Dragonflight##10569
		.info Open the Hoard of the Black Dragonflight in your bags.
		.' Make sure to save the Black Dragonflight Molt|collect Black Dragonflight Molt##10575|q 4022 |future
	step //74
		.' Go south to Blackrock Mountain|goto Searing Gorge,34.5,83.6,1|q 2784 |future
	step //75
		.' Run through Blackrock Mountain over to the Burning Steppes|goto Burning Steppes|q 2784 |future
	step //76
		goto Burning Steppes,65.7,24.2
		.talk Vahgruk##13177
		.fpath Flame Crest
	step //77
		goto Burning Steppes,65.7,24.2|n
		.talk Vahgruk##13177
		.' Fly to Stonard|goto Swamp of Sorrows,46.1,54.7,0.1|noway|q 2784 |future
	step //78
		goto Swamp of Sorrows,45.2,56.7
		.talk Innkeeper Karakul##6930
		home Stonard|q 2784 |future
	step //79
		goto 34.3,66.1
	...
	step //80
		goto 22.9,48.2
		.' Interact with gameobject: Soggy Scroll
	...
	step //81
		.' Hearth to Stonard|goto 45.1,56.7,0.1|use Hearthstone##6948|noway|q 2621
	step //82
		goto 47.9,55
	...
	step //84
		goto 66.4,76.2|n
		.' The path to 'The Swamp Talker' starts here|goto Swamp of Sorrows,66.4,76.2,0.5|noway|q 2623
	step //85
		goto 62.8,88.3
		.from Swamp Talker##950
		.info It stands at the very back of the cave.
		.get Warchief's Orders##8463|q 2623/1
	step //86
		goto 91.6,67.6
		.kill Jarquia##9916|n
	...
	step //89
		goto 46.1,54.8|n
		.talk Breyk##6026
		.' Fly to Booty Bay|goto Stranglethorn Vale,26.8,77.0,0.1|noway|q 625
	step //90
		goto 25.75,73.05|n
		.' Ride the boat to Ratchet|goto The Barrens|q 625
	step //91
		goto The Barrens,63.1,37.2|n
		.talk Bragok##16227
		.' Fly to Mudsprocket|goto Dustwallow Marsh,42.9,72.4,0.1|noway|q 625
	step //92
	...
	step //94
		goto 42.8,72.4|n
		.talk Dyslix Silvergrub##23612
		.' Fly to Gadgetzan|goto Tanaris,51.6,25.5,0.1|noway|q 4450
	step //95
	...
	step //96
		goto 51.6,25.4|n
		.talk Bulkrek Ragefist##7824
		.' Fly to Orgrimmar|goto Orgrimmar|q 81
	step //97
		goto Orgrimmar,54.1,68.4
		.talk Innkeeper Gryshka##6929
		home Orgrimmar|q 81
	step //98
		goto Orgrimmar,59.5,36.8
		.talk Dran Droffers##6986
		..turnin Ripple Delivery##81
	step //99
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to Valormok|goto Azshara,22.0,49.7,0.1|noway|q 3517 |future
	step //100
	...
	step //102
		...
		.collect Tablet of Sael'hai##10541|q 3517/4
		.info The Tablet of Sael'hai is a big stone slab with a yellow symbol on it.
		.collect Tablet of Markri##10540|q 3517/3
		.info The Tablet of Markri is a small stone slab with a green symbol on it.
		.collect Tablet of Beth'Amara##10538|q 3517/1
		.info The Tablet of Beth'Amara is a small stone slab with a pink symbol on it.
		.collect Tablet of Jin'yael##10539|q 3517/2
		.info The Tablet of Jin'yael is a small stone slab with a blue symbol on it.
	step //103
	...
	step //108
		goto 43.3,47.5|n
		.' The path back up to the Ruins of Eldarath starts here|goto Azshara,43.3,47.5,0.5|noway|q 3517
	step //109
		goto 22.6,51.4
		.talk Jediga##8587
	...
	step //110
		...
		.' He will teleport you up into the mountains|goto Azshara,26.3,46.2,0.5|noway|q 3561
	step //111
		.' Follow the path up the mountain into the tower at the top|goto Azshara,29,41,0.5|q 3561
	step //112
		goto 29.4,40.4
	...
	step //113
		.' Go back down the path|goto Azshara,26.9,42.8,1|q 3565
	step //114
		goto 26.5,46.3
		.talk Nyrill##8399
		..accept Return Trip##3421 |instant
		.' He will teleport you back down out of the mountains|goto Azshara,28.1,50.3,0.5|noway|q 3565
	step //115
		goto 22.6,51.4
		.talk Jediga##8587
	...
	step //116
		goto 53.9,18.9|n
		.' The path up to Kim'jael starts here|goto Azshara,53.9,18.9,0.5|noway|q 3601 |future
	step //117
		goto 53.5,21.8
		.talk Kim'jael##8420
	...
	step //119
		goto 59.5,31.3
		.' Interact with gameobject: Kaldorei Tome of Summoning
		..turnin Betrayed (2)##3505
		..accept Betrayed (3)##3506
		.info It's a book sitting on the little altar.
	step //120
		goto 59.5,31.6
		.' Interact with gameobject: Arcane Focusing Crystals
		.kill Blood Elf Defender##8581|n
		.info After the Blood Elf Defender dies, Magus Rimtori will spawn.
		.from Magus Rimtori##8578
		.get Head of Magus Rimtori##10597|q 3506/1
	step //121
		goto 58.5,25
	...
	step //122
		goto 56,25
		.kill 10 Blood Elf Reclaimer##6199|q 3505/2
		.kill 10 Blood Elf Surveyor##6198|q 3505/3
	step //123
		goto 53.5,21.8
		.talk Kim'jael##8420
	...
	step //125
		goto 22,49.6|n
		.talk Kroum##8610
		.' Fly to Thunder Bluff|goto Thunder Bluff|q 3518
	step //126
		goto Thunder Bluff,69.9,30.9
		.talk Magatha Grimtotem##4046
	...
	step //127
		.' Hearth to Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 3541
	step //128
		goto 55.6,34.1
		.talk Jes'rimon##8659
	...
	step //130
		.' Go outside of Orgrimmar|goto Durotar|q 3542
	step //131
		goto Durotar,50.85,13.75|n
		.' Ride the zeppelin to Undercity|goto Tirisfal Glades|noway|q 3542
		.info You can ride zeppelins to either Undercity or the Grom'Gol Base Camp here.
	step //132
		.' Go south to Undercity|goto Undercity|q 3542
	step //133
	...
	step //137
		goto 63.3,48.6|n
		.talk Michael Garrett##4551
		.' Fly to Revantusk Village|goto The Hinterlands,81.7,81.9,0.1|noway|q 7840 |future
	step //138
	...
	step //140
		goto 78,69
		.kill 10 Saltwater Snapjaw##2505|q 7815/1
	step //141
		goto 79,62
		.from Gammerita##7977
		.get Katoom's Best Lure##19023|q 7816/1
	...
	step //147
		ding 53
	step //148
		.' Hearth to Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 3562
	step //149
		goto 45.1,63.9|n
		.talk Doras##3310
		.' Fly to Valormok|goto Azshara,22.0,49.7,0.1|noway|q 3562
	step //150
		goto Azshara,22.6,51.4
		.talk Jediga##8587
	...
	step //151
		goto 22,49.6|n
		.talk Kroum##8610
		.' Fly to Ratchet|goto The Barrens,63.1,37.1,0.1|noway|q 2581 |future
	step //152
		goto The Barrens,63.65,38.6|n
		.' Ride the boat to Booty Bay|goto Stranglethorn Vale|q 2581 |future
	step //153
		goto 26.9,77.1|n
		.talk Gringer##2858
		.' Fly to Stonard|goto Swamp of Sorrows,46.1,54.7,0.1|noway|q 2581 |future
	step //154
		.' Go southwest to the Blasted Lands|goto Blasted Lands|q 2581 |future
	step //155
	...
	step //156
		...
		.collect 6 Blasted Boar Lung##8392|q 2581 //? |q 2581/1,2582,2583,2584,2585,2586
		.collect 5 Snickerfang Jowl##8391|q 2581 //? |q 2581/1,2582,2603,2604
		.collect 14 Vulture Gizzard##8396|q 2585 //? |q 2585/1,2586,2601,2602,2603,2604
		.collect 11 Basilisk Brain##8394|q 2583 //? |q 2583/1,2584,2601,2602
		.collect 6 Scorpok Pincer##8393|q 2581 //? |q 2581/1,2582,2583,2584,2585,2586
		.' At Grind Point 1|at 49,18
		.' At Grind Point 2|at 45,26
		.' At Grind Point 3|at 56,37
		.' At Grind Point 4|at 56.3,30.5
		.' At Grind Point 5|at 63,28
	step //157
		goto 50.6,14.2
		.talk Bloodmage Drazial##7505
	...
	step //158
		.' Hearth to Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 32
	step //159
		goto Orgrimmar,55.8,64.8
		.talk Auctioneer Wabang##8724
		.buy 1 Mithril Casing##10561|q 4244/1
	step //160
		goto Orgrimmar,56.5,46.5
		.talk Zilzibin Drumlore##7010
	...
	step //161
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to Gadgetzan|goto Tanaris,51.6,25.5,0.1|noway|q 2641
	step //162
		goto Tanaris,51.1,26.9
		.talk Sprinkle##7583
	...
	step //166
		.' Go southwest to Un'Goro Crater|goto Un'Goro Crater|q 4290 |future
	step //167
		goto 71.6,76
	...
	step //168
		...
		.get 15 Un'Goro Slime Samples##12235|n
	...
	step //177
		...
		.info Kill Un'Goro Gorillas inside the cave.
	step //178
		goto 46.4,13.5
	...
	step //188
		goto 47,19
		.from Tar Lurker##6518, Tar Lord##6519
		.get 12 Super Sticky Tar##11834|q 4504/1
	step //189
		goto 44.4,26.5
		.kill 5 Bloodpetal Flayer##6510|q 4145/3
	step //190
		goto 56.5,12.4
		.' Interact with gameobject: Northern Pylon
	...
	step //191
		goto 57,9
		.from Fledgling Pterrordax##9165, Pterrordax##9166, Frenzied Pterrordax##9167
		.get 8 Webbed Pterrordax Scale##11831|q 4503/2
		.' You can find alot more of them|at 56.9,87.5
		.info If you need to go to this second spot, do so a little later, after you finish up at the insect area.
	step //192
		.' Go east into the gorilla cave|goto Un'Goro Crater,63.1,17.1,1|q 4243
	step //193
		goto 67.6,16.8
		.talk A-Me 01##9623
	...
	step //194
		...
		.kill 5 Bloodpetal Lasher##6509|q 4145/1
		.kill 5 Bloodpetal Thresher##6511|q 4145/4
	step //195
		goto 68.5,36.6
	...
	step //196
		goto 77.2,49.9
		.' Interact with gameobject: Eastern Pylon
	...
	step //198
		...
		.' The path down to 'Alien Ecology' starts here|goto Un'Goro Crater,50.4,77.9,0.5|noway|q 3883
	step //199
		goto 48.6,85.2
		.' Go down the path
		...
		.get Hive Wall Sample##11131|q 3883/1
	step //200
		goto 48.8,77.6
		.' Kill Gorishi insects
		.get Gorishi Scent Gland##11837|q 4496/1
	step //201
		goto 49,69
		.kill 5 Bloodpetal Trapper##6512|q 4145/2
	step //202
		goto 38.5,66.1
	...
	step //203
		goto 23.8,59.2
		.' Interact with gameobject: Western Pylon
	...
	step //205
		...
		.info You only need to collect 25 total Un'Goro Soil for this step, you do not need 30.
	step //206
		goto 30.9,50.4
		.talk Krakle##10302
	...
	step //207
		goto 52.7,42.1|n
		.' The path up to 'Finding the Source' starts here|goto Un'Goro Crater,52.7,42.1,0.5|noway|q 974
	step //208
		goto 49.7,45.7
		.' Follow the path up
	...
	step //211
		goto 54.4,50.3|n
		.' The path up to 'Lost!' starts here|goto Un'Goro Crater,54.4,50.3,0.5|noway|q 4492
	step //212
		goto 51.9,49.9
		.talk Ringo##9999
		..turnin Lost!##4492
...
startlevel 55
	...
	step //4
		.' Go southeast to the gorilla cave|goto Un'Goro Crater,63.1,17.1,1|q 4301
	step //5
		goto 68.55,11.95
		.kill U'cha##9622|n
	...
	step //9
		.' Go southeast to Tanaris|goto Tanaris|q 4504
	step //10
		goto Tanaris,51.6,26.8
		.talk Tran'rek##7876
	...
	step //12
		.' Hearth to the Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 936 |future
	step //13
		goto Orgrimmar,54.1,68.4
		.talk Innkeeper Gryshka##6929
		..accept Assisting Arch Druid Runetotem##936
	step //14
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to Thunder Bluff|goto Thunder Bluff|noway|q 936
	step //15
		goto Thunder Bluff,78.6,28.5
		.talk Arch Druid Hamuul Runetotem##5769
		..turnin Assisting Arch Druid Runetotem##936
	...
	step //17
		goto 47,49.8|n
		.talk Tal##2995
		.' Fly to Ratchet|goto The Barrens,63.1,37.1,0.1|noway|q 4147
	step //19
	...
	step //20
		goto The Barrens,63.65,38.6|n
		.' Ride the boat to Booty Bay|goto Stranglethorn Vale|q 4133
	step //21
		goto Stranglethorn Vale,26.9,77.1|n
		.talk Gringer##2858
		.' Fly to Kargath|goto Badlands,4.1,44.9,0.5|noway|q 4133
	step //22
		goto Badlands,2.9,47.8
	...
	step //23
		...
		.info If he, and the group of people he is with, are not there, just wait a few minutes and they will come back.
	step //24
		goto 4,44.8|n
		.talk Gorrik##2861
		.' Fly to Flame Crest|goto Burning Steppes,65.6,24.2,0.1|noway|q 4324
	step //25
	...
	step //27
		...
		.kill Black Broodling##7047|n
		.collect 8 Broodling Essence##12283|q 4726/1
		.info The red crystal hovering over their corpses.
		.' There are more Black Broodlings around|at 91.8,36.8
		.' There are also more around|at 88.3,58.8
	step //28
		goto 79.9,45.4
		.' Interact with gameobject: Sha'ni Proudtusk's Remains
		.talk Sha'ni Proudtusk##9136
		..turnin Dreadmaul Rock##3821
		..accept Krom'Grul##3822
		.info She is kind of invisible, so look hard.
	step //29
		.' Krom'Grul can spawn in any of the 3 caves on this mountain, so you will probably have to search for him:
		.from Krom'Grul##8977
		.get Sha'ni's Nose-Ring##11058|q 3822/1
	step //30
		goto 68.8,37.8
		.from War Reaver##7039
		.get 10 Fractured Elemental Shard##11266|q 4061/1
	step //31
		goto 54.1,40.7
	...
	step //33
		goto 65.7,24.2|n
		.talk Vahgruk##13177
		.' Fly to Kargath|goto Badlands,4.1,44.9,0.5|noway|q 3822
	step //34
	...
	step //37
		ding 56
	step //38
		.' Hearth to the Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 4300
	step //39
	...
	step //42
		goto 45.1,63.9|n
		.talk Doras##3310
		.' Fly to Splintertree Post|goto Ashenvale,73.3,61.7,0.1|noway|q 8460 |future
	step //43
		.' Go northwest to Felwood|goto Felwood|q 8460 |future
	step //44
	...
	step //51
		goto 42.4,67.8
		.from Cursed Ooze##7086, Tainted Ooze##7092
	...
	step //53
		.' Go north to the river and follow the river west|goto 38.05,49.83,0.5|q 6162 |future
	step //54
		goto 34.8,52.7
		.talk Dreka'Sur##9620
	...
	step //57
		...
		.get 15 Blood Amber##11503|q 4102/1
	step //58
		goto 56,12.5
		.kill 12 Felpaw Ravager##8961|q 4120/2
		.kill 12 Angerclaw Grizzly##8957|q 4120/1
	...
	step //62
		.' Go through the tunnel to Winterspring|goto Winterspring|q 8465
		.info At the fork, the tunnel heading east leads to Winterspring.
	step //63
	...
	step
		...
		..accept A Strange One##6605
	step //66
		.' Go north at the fork into Moonglade|goto Moonglade|q 6605
		.info Go west into the tunnel.
	step //67
		goto Moonglade,32.1,66.6
		.talk Faustron##12740
		.fpath Moonglade
	step
		goto Moonglade,32.1,66.6|n
		.talk Faustron##12740
		.' Fly to Bloodvenom Post|goto Felwood,34.5,54,0.5|noway|q 6605
	step
		goto Felwood,34.2,52.3
		.talk Winna Hazzard##9996
		..turnin A Strange One##6605
		..accept Well of Corruption##4505
	step //68
		goto 34.5,54|n
		.talk Brakkar##11900
		.' Fly to Thunder Bluff|goto Thunder Bluff|q 1018
	step //69
	...
	step //71
		goto Thunder Bluff,47,49.8|n
		.talk Tal##2995
		.' Fly to Camp Mojache|goto Feralas,75.4,44.3,0.1|noway|q 4120
	step //72
	...
	step //74
		...
		.collect Evoroot##11242|q 3909
	step //75
		goto 45.1,25.6
		.talk Gregan Brewspewer##7775
		.' Give him the Evoroot
		.get Videre Elixir##11243|q 3909/1
	step //76
		.' Hearth to the Orgrimmar|goto Orgrimmar|use Hearthstone##6948|noway|q 5155
	step //77
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to Emerald Sanctuary|goto Felwood,51.4,82.3,0.1|noway|q 5155
	step //78
	...
	step //81
		goto 48.3,94.2
		.from Overlord Ror##9464
		.get Overlord Ror's Claw##15879|q 6162/1
	step //82
		goto 48.6,90.8
	...
	step //84
		...
		.info Use your Hardened Flasket in the small green pool of water.
		.get Filled Flasket##12567|q 4505/1
	step //85
		goto 35.2,59.8
		.use Empty Canteen##12922
		.info Use your Empty Canteen in the small green pool of water.
		.get Corrupt Moonwell Water##12907|q 5157/1
	step //86
		.' Go northeast to the green river, then go west|goto 38.2,49.8,0.5|q 4505
	step
		goto 34.2,52.3
		.talk Winna Hazzard##9996
	...
	step //90
		goto 34.4,54|n
		.talk Brakkar##11900
		.' Fly to Emerald Sanctuary|goto Felwood,51.4,82.3,0.3|noway|q 5157
	step //91
		goto 51.2,82.1
		.talk Greta Mosshoof##10922
	...
	step //92
		goto 51.5,82.2|n
		.talk Gorrim##22931
		.' Fly to Moonglade|goto Moonglade|q 1123
	step //93
	...
	step //95
		goto 32.1,66.6|n
		.talk Faustron##12740
		.' Fly to Everlook|goto Winterspring,60.5,36.3,0.1|noway|q 4808
	step //96
	...
	step //97
		goto Winterspring,61.4,38.8
		.talk Innkeeper Vizzie##11118
		home Everlook|q 5082
	step //98
		goto 61.6,38.6
	...
	step //100
		...
		.' More of the above mobs can be found around|at 30.8,35.7
	step
	...
	step //106
		.' Hearth to Everlook|goto 61.3,38.8,0.1|use Hearthstone##6948|noway|q 977
	step //107
		goto 60.9,37.6
		.talk Umi Rumplesnicker##10305
		..turnin Are We There. Yeti? (2)##977
	...
	step //112
		goto 38.5,38.7
		.kill 15 Ragged Owlbeast##7450|q 4521/2
		.info Kill Ragged Owlbeasts while heading east in the mountains north and south of the road.
	step //113
		goto 59.3,28
		.kill 15 Raging Owlbeast##7451|q 4521/1
	step //114
		goto 61,22
		.from Chillwind Ravager##7449
	...
	step //116
		goto 60.5,36.3|n
		.talk Yugrek##11139
		.' Fly to Bloodvenom Post|goto Felwood,34.4,53.9,0.1|noway|q 4521
	step //117
	...
	step //118
		goto 34.4,54|n
		.talk Brakkar##11900
		.' Fly to Gadgetzan|goto Tanaris,51.6,25.5,0.1|noway|q 3912
	step //119
		goto Tanaris,51.1,26.9
		.' Use Umi's Mechanical Yeti on Sprinkle|use Umi's Mechanical Yeti##12928
	...
	step //123
		goto 53.8,29.1
		.' Interact with gameobject: Conspicious Gravestone
	...
	step //124
		goto 51.6,25.4|n
		.talk Bulkrek Ragefist##7824
		.' Fly to Marshal's Refuge|goto Un'Goro Crater,45.3,6.0,0.1|noway|q 3914
	step //125
		goto Un'Goro Crater,43.7,9.4
		.' Use Umi's Mechanical Yeti on Quixxle|use Umi's Mechanical Yeti##12928
	...
	step //128
		goto 29.2,22.1|n
		.' The path over to Silithus starts here|goto Un'Goro Crater,29.2,22.1,0.5|noway|q 1124
	step //129
		.' Go west to Silithus|goto Silithus|q 1124
	step //130
	...
	step //133
		...
		home Cenarion Hold|q 8277 |future
	step //134
		goto 51.7,38.6
		.talk Beetix Ficklespragg##15189
		..accept Deadly Desert Venom##8277
	...
	step //138
		...
		.info They look like little blue glowing fragments on the ground around this area.
	step //139
		.' Hearth to Cenarion Hold|goto Silithus,51.9,39.2,0.3|noway|use Hearthstone##6948|q 8277
	step //140
		goto 51.7,38.6
		.talk Beetix Ficklespragg##15189
		..turnin Deadly Desert Venom##8277
	...
	step //145
		...
		.' You can find more Stonelash Flayers and Rock Stalkers|at 46.2,70.2
	step //146
		goto 51.2,38.3
		.talk Windcaller Proudhorn##15191
		..turnin Stepping Up Security##8281
	...
	step //148
		goto 48.7,36.7|n
		.talk Runk Windtamer##15178
		.' Fly to Emerald Sanctuary|goto Felwood,51.4,82.3,0.1|noway|q 3942
	step //149
	...
	step //150
		goto 51.5,82.2|n
		.talk Gorrim##22931
		.' Fly to Ratchet|goto The Barrens,63.1,37.1,0.3|noway|q 4810
	step //151
		goto The Barrens,63.65,38.6|n
		.' Ride the boat to Booty Bay|goto Stranglethorn Vale|q 4810
	step //152
		goto Stranglethorn Vale,26.9,77.1|n
		.talk Gringer##2858
		.' Fly to Flame Crest|goto Burning Steppes,65.6,24.2,0.1|noway|q 4810
	step //153
		goto Burning Steppes,65.2,23.9
		.talk Tinkee Steamboil##10267
	...
	step //154
		goto 65.7,24.2|n
		.talk Vahgruk##13177
		.' Fly to Undercity|goto Undercity|q 4293
	step //155
		goto Undercity,47.5,73.1
		.' Interact with gameobject: Testing Equipment
		.info They look like 2 small pots with red and green liquid in them.
		...
		.get 5 Corrupted Felwood Sample##12234|q 4293/1
		.get 5 Pure Un'Goro Sample##12236|q 4294/1
	...
	step //158
		...
		home Undercity|q 5023 |future
	step //159
		.' Go outside of Undercity|goto Tirisfal Glades|q 5095
	step //160
		goto Tirisfal Glades,83.57,69.95
		.talk Timothy Cunningham##37915
		.fpath The Bulwark
	step //161
		...
		..accept Scarlet Diversions##5096
	step
		goto Tirisfal Glades,83.15,69.09
		.collect Flame in a Bottle##12814|q 5096
		.info A small box near the campfire.
	step //162
		goto 83.2,68.5
		.talk Argent Officer Garush##10839
		..turnin The Everlook Report##6029
	step //163
		.' Go east to the Western Plaguelands|goto Western Plaguelands|q 5021 |future
	step //164
		goto Western Plaguelands,38.4,54.1
		.talk Janice Felstone##10778
		..accept Better Late Than Never (1)##5021
	...
	step //166
		goto 40.7,51.9
		.' Interact with gameobject: Command Tent
		.info The tent should catch fire after you click on it.
		.' Click the Scourge Banner in your bags|use Scourge Banner##12807
		.' Plant the Scourge Banner in the camp
		.goal Destroy the command tent and plant the Scourge banner in the camp|q 5096/1
		.info It's a white tent.
	step //167
		.' Go west to Tirisfal Glades|goto Tirisfal Glades|q 5096
	step //168
		goto Tirisfal Glades,83.1,68.9
		.talk High Executor Derrington##10837
		..turnin Scarlet Diversions##5096
	...
	step //169
		...
		..accept Target: Felstone Field##5229
	step //170
		.' Go east to the Western Plaguelands|goto Western Plaguelands|q 5229
	step //171
		goto Western Plaguelands,37,57.2
		.kill Cauldron Lord Bilemaw##11075|n
		.collect Felstone Field Cauldron Key##13194|q 5229
	step
		...
		..accept Return to the Bulwark##5230
	step //172
		.' Go west to Tirisfal Glades|goto Tirisfal Glades|q 5230
	step //173
		goto Tirisfal Glades,83,71.9
		.talk Shadow Priestess Vandis##11055
		..turnin Return to the Bulwark##5230
		..accept Target: Dalson's Tears##5231
	step //174
		.' Go east to the Western Plaguelands|goto Western Plaguelands|q 5231
	step //175
		goto Western Plaguelands,46.2,52.5
		.kill Cauldron Lord Malvinious##11077|n
		.collect Dalson's Tears Cauldron Key##13195|q 5231
	step
		...
		..accept Return to the Bulwark##5232
	step //176
		.' Go west to Tirisfal Glades|goto Tirisfal Glades|q 5232
	step //177
		goto Tirisfal Glades,83,71.9
		.talk Shadow Priestess Vandis##11055
		..turnin Return to the Bulwark##5232
		..accept Target: Writhing Haunt##5233
	step //178
		.' Go east to the Western Plaguelands|goto Western Plaguelands|q 5233
	step //179
		goto Western Plaguelands,53,66
		.kill Cauldron Lord Razarch##11076|n
		.collect Writhing Haunt Cauldron Key##13197|q 5233
	step
		...
		..accept Return to the Bulwark##5234
	step //180
		.' Go northwest to Tirisfal Glades|goto Tirisfal Glades|q 5234
	step //181
		goto Tirisfal Glades,83,71.9
		.talk Shadow Priestess Vandis##11055
		..turnin Return to the Bulwark##5234
		..accept Target: Gahrron's Withering##5235
	step //182
		.' Go east to the Western Plaguelands|goto Western Plaguelands|q 5235
	step //183
		goto Western Plaguelands,62.6,58.9
		.kill Cauldron Lord Soulwrath##11078|n
		.collect Gahrron's Withering Cauldron Key##13196|q 5235
	step
	...
	step
		goto Western Plaguelands,69.26,49.66|n
		.talk Frax Bucketdrop##37888
		.' Fly to Bulwark|goto Tirisfal Glades,83.57,69.95,0.5|noway|q 5236
	step //186
		goto Tirisfal Glades,83,71.9
		.talk Shadow Priestess Vandis##11055
		..turnin Return to the Bulwark##5236
	...
	step //188
		goto 83.6,69.9|n
		.talk Timothy Cunningham##37915
		.' Fly to Thondroril River|goto Western Plaguelands,69.26,49.66,0.5|noway|q 5601
	step //190
		goto Eastern Plaguelands,4.7,38.3
		.talk Tirion Fordring##1855
		..accept Demon Dogs##5542
		..accept Blood Tinged Skies##5543
		..accept Carrion Grubbage##5544
	...
	step //192
		...
		.' You can find more around|at 29.6,76.7
	step //193
		goto 32.4,83.7
		.talk Pamela Redpath##10926
		..turnin Sister Pamela##5601
	...
	step //194
		goto 35.0,84.3
		.' The doll parts spawn in the house here, except the house Pamela is in:
		.collect Pamela's Doll's Head##12886|q 5149
		.collect Pamela's Doll's Left Side##12887|q 5149
		.collect Pamela's Doll's Right Side##12888|q 5149
	step
		.use Pamela's Doll's Head##12886
		.info Click Pamela's Doll's Head to put the doll parts together to make Pamela's Doll.
		.goal Pamela's Doll|q 5149/1
	step //195
		goto 32.4,83.7
		.talk Pamela Redpath##10926
		..turnin Pamela's Doll##5149
	...
	step //199
		goto 61.4,36.7
		.from Diseased Flayer##8532
		.info After their kill, ghosts will appear with whom you need to talk.
		.talk Darrowshire Spirit##11064
		.' Free 15 Darrowshire spirits|goal 15 Darrowshire Spirits Freed|q 5211/1
	step //200
		goto 58.3,38.4
	...
	step
		goto 74.5,51.2|n
		.talk Georgia##12636
		.' Fly to Thondroril River|goto Western Plaguelands,69.26,49.66,0.5|noway|q 6042
	step //202
		goto Eastern Plaguelands,23,68.2
		.talk Nathanos Blightcaller##11878
		..turnin Un-Life's Little Annoyances##6042
	...
	step
		goto 4.7,38.3
		.talk Tirion Fordring##1855
		.' Listen to what Tirion Fordring has to say|q 5742/1
		..turnin Redemption##5742
	step //204
		.' Hearth to Undercity|goto Undercity|use Hearthstone##6948|noway|q 5023
	step //205
		goto Undercity,69.8,43.1
		.talk Royal Overseer Bauhaus##10781
		..turnin Better Late Than Never (2)##5023
	...
	step //206
		...
		..turnin The Jeremiah Blues##5049
	step //207
		.' Go outside of Undercity|goto Tirisfal Glades|q 5163
	step //208
		goto Tirisfal Glades,60.8,58.8|n
		.' Ride the zeppelin to Orgrimmar|goto Durotar|noway|q 5163
		.info You can ride this zeppelin to Orgrimmar or Grom'Gol Base Camp.
	step //209
		.' Go northwest to Orgrimmar|goto Orgrimmar|q 5163
	step //210
		goto Orgrimmar,45.1,63.9|n
		.talk Doras##3310
		.' Fly to Everlook|goto Winterspring,60.5,36.3,0.1|noway|q 5163
	step //211
		goto Winterspring,60.9,37.6
		.talk Umi Rumplesnicker##10305
		..turnin Are We There, Yeti? (3)##5163
	step //212
		goto Winterspring,60.5,36.3|n
		.talk Yugrek##11139
...
startlevel 60
	...
	step //3
		.' Go into the big green portal to Outland|goto Hellfire Peninsula|q 9407
	step //4
...
startlevel 64
	...
	step
		goto 39,43.7
		.talk Scout Neftis##18714
		.' She puts an orc disguise on you|havebuff Spell_Shadow_NetherCloak
	step //132
		goto 40.3,39.1
...
startlevel 66
	...
	step //2
		goto 66.3,34.7
		.from Ironjaw##18670
		.get Ironjaw's Pelt##25837|q 10023/1
	...
	step //5
		...
		.' It will teleport you to the top of the tower|goto 73.5,35.0,0.2|noway|q 10447
		.info Upstairs from Isla Starmane, on the balcony.
	step //6
		goto 73.9,35.8
		.kill Sharth Voldoun##18554|n
		.collect The Final Code##29912|q 10447
		.info Up the winding ramp.
	step //7
		goto 74.2,36.5
		.' Click the Orb of Translocation
		.' It will teleport you to the bottom of the tower|goto 73.3,36.3,0.2|noway|q 10447
	...
	step //12
		goto 49.2,43.4|n
		.talk Kerna##18807
		.' Fly to Shattrath City|goto Shattrath City|noway|q 10006
	step //13
		.' Go outside to Terokkar Forest|goto Terokkar Forest|noway|q 10006
	step //14
		goto Terokkar Forest,44.3,26.3
		.talk Earthbinder Tavgren##18446
		..turnin Letting Earthbinder Tavgren Know##10006
	step //15
		.' Go west to Shattrath City|goto Shattrath City|noway|q 9797 |future
	step //16
		goto Shattrath City,64.1,41.1|n
		.talk Nutral##18940
		.' Fly to Zabra'jin|goto Zangarmarsh,31.7,49.8,4|noway|q 9797 |future
	step //17
		goto Zangarmarsh,32,50.4
		.talk Messenger Gazgrigg##18091
		..accept Reinforcements for Garadar##9797
	step //18
		goto Zangarmarsh,33.1,51.1|n
		.talk Du'ga##18791
		.' Fly to Swamprat Post|goto Zangarmarsh,85.2,54.2,2|noway|q 9854 |future
	step //19
		.' Go southwest to Nagrand|goto Nagrand|noway|q 9854 |future
	step //20
	...
	step //30
		...
		.' Interact with gameobject: Garadar Bulletin Board
	...
	step //35
		...
		.info He may not be in this spot, he wanders around the Throne of Elements area.
	step //36
		goto 52.1,25.6
		.kill 12 Talbuk Thorngrazer##17131|q 9858/1
		.' Interact with gameobject: Dung piles
	...
	step //38
		goto 46.5,18.2
		.kill Zorbo the Advisor##18413|q 9939/1
	step //39
		goto 48.3,21.5
		.kill 10 Warmaul Shaman##18064|q 9939/2
		.kill 10 Warmaul Reaver##17138|q 9939/3
		.get 10 Obsidian Warbeads##25433|q 10479/1
	step //40
		goto 32.4,36.1
	...
	step //41
		goto 29.2,31.6|n
		.' The path up to 'War on the Warmaul' and 'Finding the Survivors' starts here|goto Nagrand,29.2,31.6,0.5|noway|q 9945
	step //42
		goto 23.4,29.2
		.kill 8 Warmaul Brute##18065|q 9945/1
		.kill 8 Warmaul Warlock##18037|q 9945/2
		.collect Warmaul Prison Key##25604|q 9948 |n
		.' Click the yellow cages around this area
	...
	step //44
		...
		.' You can find more around (1)|at 41.05,48.08
		.' You can find more around (2)|at 43.9,47.65
	step //45
		goto 30.9,42.3
		.from Ortor of Murkblood##18204
		.get Head of Ortor of Murkblood##24543|q 9867/1
	step //46
		goto 32.2,42.7
		...
		.get 10 Murkblood Idol##24542|q 9863/1
	step //47
		goto 32.4,36.1
		.talk Saurfang the Younger##18229
	...
	step //61
		.' Go southeast to Terokkar Forest|goto Terokkar Forest|noway|q 9888
	step //62
	...
	step //66
		ding 67
	step //67
		.' Hearth to Garadar|goto Nagrand,55.0,36.8,6|use Hearthstone##6948|noway|q 9891
	step //68
	...
	step //77
		...
		.info You can find them all along this cliffside.
	...
	step //90
		...
		.get 10 Bleeding Hollow Supply Crate##25460|q 9916/1
	...
	step //94
		.'Hearth to Garadar|goto Nagrand,55.0,36.8,6|use Hearthstone##6948|noway|q 9916
	step //95
		goto 55.5,37.6
		.talk Elkay'gan the Mystic##18300
	...
	step //97
		goto 73.8,68.1|n
		.' The path up to Lantressor of the Blade starts here|goto Nagrand,73.8,68.1,0.5|noway|q 10107
	step //98
		goto 73.8,62.6
	...
	step //99
		...
		.get 10 Kil'sorrow Armaments##25554|q 9928/1
	...
	step //100
		goto 71.1,82.4
		.kill Giselda the Crone##18391|q 9935/1
	...
	step //107
		.' Hearth to Garadar|goto Nagrand,55.0,36.8,6|use Hearthstone##6948|noway|q 9934
	step //108
		goto 55.5,37.6
		.talk Garrosh##18063
		..turnin Message to Garadar##9934
	step //109
		.' Fly to Swamprat Post|goto Zangarmarsh,85.2,54.2,2|noway|q 10928 |future
	step //110
		goto Zangarmarsh,70.1,33.8|n
		.' The path to Blade's Edge Mountains starts here|goto Zangarmarsh,70.1,33.8,0.5|noway|q 10928 |future
	step //111
		.' Go north to Blade's Edge Mountains|goto Blade's Edge Mountains|noway|q 10928 |future
	step //112
	...
	step //121
		.' Go west across the big bridge|goto Blade's Edge Mountains,42.8,65.6,0.5|q 10487
	step //122
		goto 41.2,67.2
		.from Fey Drake##20713
		.get 4 Dust of the Fey Drake##30174|q 10487/1
	step //123
		goto 37.1,70
		.' He walks up and down this road
		.' Kill Stronglimb Deeproot
		.get Stronglimb Deeproot's Trunk##30177|q 10489/1
	...
	step //128
		goto 49.8,54|n
		.' The path down to Bladespire Hold starts here|goto Blade's Edge Mountains,49.8,54.1,0.5|noway|q 10503
	step //129
		goto 41.6,54.0
	...
	step //131
		goto 40.9,51.9|n
		.' The path up to the Thunderlord Clan Arrow starts here|goto Blade's Edge Mountains,40.9,51.8,0.3|noway|q 10524
	step //132
		goto 41.5,52.6
		.' Click the Thunderlord Clan Arrow
		.get Thunderlord Clan Arrow##30433|q 10524/1
	...
	step //133
		...
		.get Thunderlord Clan Tablet##30434|q 10524/3
	...
	step //136
		goto 51.7,51.5|n
		.' Follow the path down|goto Blade's Edge Mountains,51.7,51.5,0.5|noway|q 10542
	step //137
		goto 45,72.3
	...
	step //138
		...
		.' Click the Bloodmaul Brew Kegs and kill Bloodmaul Brewmasters
		.info Bloodmaul Brew Kegs look like big wooden barrels on the ground around this area.
		.' Get 16 Bloodmaul Brutebane Brew|collect 16 Bloodmaul Brutebane Brew##29443|q 10542
		.info You need the extra Brew to make a later quest much easier.
	step //139
		goto 42.1,81.2
		.' Click T'chali's Hookah
		.get T'chali's Hookah##30468|q 10542/1
	...
	step //141
		...
		.' Kill Gor Grimgut
		.get The Thunderspike##30435|q 10526/1
	...
	step //143
		...
		.get 5 Bladespire Ogres drunk##21241|q 10545/1
	step //144
		goto 45,72.3
		.talk T'chali the Witch Doctor##21349
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Leveling Guides\\Northrend (70-72)",[[
	...
	step //141
		goto 41.2,41.8|n
		.' The path down to Monitoring the Rift: Cleftcliff Anomaly starts here|goto 41.2,41.8,0.5|noway|q 11576
	step //142
		goto 34.3,42
	...
	step //145
		goto 46.8,29.3|n
		.' The path down to Monitoring the Rift: Sundered Chasm starts here|goto 46.8,29.3,0.5|noway|q 11582
	step //146
	...
	step //148
		goto 46.8,29.3|n
		.' The path down to Monitoring the Rift: Sundered Chasm starts here|goto 46.8,29.3,0.5|noway|q 12728
	step //149
		goto 40.1,19.7
	...
	step //157
		...
		.info Use your Beryl Shield Detonator inside the big blue glowing circle.
	...
	step //180
		...
		.' Interact with gameobject: Blue Dragon Eggs
		.info The Blue Dragon Eggs look like big eggs with blue crystals on them on the ground.
	...
	step //184
		goto 24.6,27.1
		.kill Nexus Drake Hatchling##26127|n
		.info They are flying above you in the sky.
		.info Use your Raelorasz's Spear on a Nexus Drake Hatchling.
...
ZygorGuidesViewer:RegisterGuide("Zygor's Horde Leveling Guides\\Northrend (74-76)",[[
	...
	step //12
		...
		.get Moonrest Gardens Plans##35783|q 11999/1
	step //13
		goto 36.3,45.6
